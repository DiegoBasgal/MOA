...
def monitoramento_view(request, *args, **kwargs):
    ...
    context = {
        ...
        "perda_grade_ug1": "{:2.2f}".format(usina.perda_grade_ug1),
        "ug1_pos_comporta": "{}".format(usina.ug1_pos_comporta),
        "setpot_ug2": "{:1.3f}".format(usina.ug2_setpot),
        "pot_ug2": "{:1.3f}".format(usina.ug2_pot),
        "tempo_ug2": "{:.2f}".format(usina.ug2_tempo),
        "perda_grade_ug2": "{:2.2f}".format(usina.perda_grade_ug2),
        "ug2_pos_comporta": "{}".format(usina.ug2_pos_comporta),
