...
def monitoramento_view(request, *args, **kwargs):
    ...
    if clp_sa.open():
        ...
        context["tensao_rs"] = clp_sa.read_input_registers(16)[0]
        context["tensao_st"] = clp_sa.read_input_registers(17)[0]
        context["tensao_tr"] = clp_sa.read_input_registers(18)[0]
