...
def monitoramento_view(request, *args, **kwargs):
    ...
    # clp_sa = ModbusClient("0.0.0.0", 502, unit_id=1, timeout=0.5, auto_close=True)
    # clp_tda = ModbusClient("0.0.0.0", 502, unit_id=1, timeout=0.5, auto_close=True)
    # clp_ug1 = ModbusClient("0.0.0.0", 502, unit_id=1, timeout=0.5, auto_close=True)
    ...
    #     context["tempo_ug1"] = f"{float((hora) + minuto):.2f}"
