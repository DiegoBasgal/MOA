    ...
    def run(self):
        ...
        while not self.dict['GLB']['stop_sim']:
            ...
            try:
                ...
                if self.tempo_afluente[contador_afluente][2] in (9910, 9920, 9930, 9940, 9950):
                    pass
                ...
                if self.tempo_afluente[contador_afluente][2] == 9940 and not self.b_ug4:
                    self.b_ug4 = True
                    self.dict['UG4']['condic'] = True

                elif self.tempo_afluente[contador_afluente][2] != 9940 and self.b_ug4:
                    self.b_ug4 = False

                if self.tempo_afluente[contador_afluente][2] == 9950 and not self.b_se:
                    self.b_se = True
                    self.dict['SE']['condic'] = True

                elif self.tempo_afluente[contador_afluente][2] != 9950 and self.b_se:
                    self.b_se = False
                ...
                if not int(self.dict['GLB']['tempo_simul'] / 60) == int(ultimo_log / 60):
                    ...
                    self.cursor.execute(
                        ...
                        {self.dict["UG4"]["potencia"]}, \
                        {self.dict["UG4"]["setpoint"]});'
                    )
                    self.conn.commit()
