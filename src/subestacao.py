...
class Subestacao:
    ...
    dct_se['tensao_r'] = lei.LeituraModbus(
        clp["SA"],
        REG_SE["TENSAO_RS"],
        escala=1000,
        descricao="[SE]  Tensão Fase RS"
    )
    dct_se['tensao_s'] = lei.LeituraModbus(
        clp["SA"],
        REG_SE["TENSAO_ST"],
        escala=1000,
        descricao="[SE]  Tensão Fase ST"
    )
    dct_se['tensao_t'] = lei.LeituraModbus(
        clp["SA"],
        REG_SE["TENSAO_TR"],
        escala=1000,
        descricao="[SE]  Tensão Fase TR"
    )
    dct_se['medidor_usina'] = lei.LeituraModbus(
        clp["SA"],
        REG_SE["POTENCIA_ATIVA_MEDIA"],
        descricao="[SE]  Leitura Medidor Usina"
    )
    dct_se['dj_linha'] = lei.LeituraModbusBit(
        clp["SA"],
    ...
    def verificar_tensao_trifasica(cls) -> "bool":
        ...
        try:
            if (TENSAO_LINHA_BAIXA < dct_se['tensao_r'].valor < TENSAO_LINHA_ALTA) \
                and (TENSAO_LINHA_BAIXA < dct_se['tensao_s'].valor < TENSAO_LINHA_ALTA) \
                and (TENSAO_LINHA_BAIXA < dct_se['tensao_t'].valor < TENSAO_LINHA_ALTA):
                return True
    ...
    def aguardar_tensao(cls) -> "bool":
        ...
        if dct_se['status_tensao'] == TENSAO_VERIFICAR:
            dct_se['status_tensao'] = TENSAO_AGUARDO
        ...
        elif dct_se['status_tensao'] == TENSAO_REESTABELECIDA:
            logger.info("[SE]  Tensão na linha reestabelecida.")
            dct_se['status_tensao'] = TENSAO_VERIFICAR
            return True

        elif dct_se['status_tensao'] == TENSAO_FORA:
    ...
    def temporizar_tensao(cls, seg: "int") -> "None":
        ...
        while time() <= delay:
            if cls.verificar_tensao_trifasica():
                dct_se['status_tensao'] = TENSAO_REESTABELECIDA
                return
            sleep(time() - (time() - 15))
        dct_se['status_tensao'] = TENSAO_FORA
    ...
    def verificar_condicionadores(cls) -> "list[c.CondicionadorBase]":
        ...
        if True in (condic.ativo for condic in dct_se['condicionadores_essenciais']):
            condics_ativos = [condic for condics in [dct_se['condicionadores_essenciais'], dct_se['condicionadores']] for condic in condics if condic.ativo]

            logger.debug("")
            if dct_se['condicionadores_ativos'] == []:
            ...
            for condic in condics_ativos:
                if condic in dct_se['condicionadores_ativos']:
                    ...
                    dct_se['condicionadores_ativos'].append(condic)
    ...
    def carregar_leituras(cls) -> "None":
        ...
        dct_se['condicionadores_essenciais'].append(c.CondicionadorBase(cls.l_alm_01_b_00, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores_essenciais'].append(c.CondicionadorBase(cls.l_alm_01_b_01, CONDIC_NORMALIZAR))

        cls.l_alm_01_b_12 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme01_12"], descricao="[SE]  Relé de Proteção SEL787 - TRIP")
        dct_se['condicionadores_essenciais'].append(c.CondicionadorBase(cls.l_alm_01_b_12, CONDIC_NORMALIZAR))

        cls.l_alm_02_b_00 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme02_00"], descricao="[SE]  Relé de Proteção SEL311C - TRIP")
        dct_se['condicionadores_essenciais'].append(c.CondicionadorBase(cls.l_alm_02_b_00, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.dj52l_gas_sf6_2, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.dj52l_flh_abertura, CONDIC_INDISPONIBILIZAR))

        cls.secc_89l_aberta = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["SECC_89L_ABERTA"], descricao="[SE]  Seccionadora 89L Aberta")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.secc_89l_aberta, CONDIC_INDISPONIBILIZAR))

        cls.l_alm_01_b_13 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme01_13"], descricao="[SE]  Relé de Proteção SEL787 - Falha 50/62BF")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_01_b_13, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_01_b_14, CONDIC_NORMALIZAR))

        cls.l_alm_02_b_01 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme02_01"], descricao="[SE]  Relé de Proteção SEL311C - Falha 50/62BF")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_01, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_02, CONDIC_NORMALIZAR))

        cls.l_alm_02_b_04 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme02_04"], descricao="[SE]  Relé de Proteção 59N - Alarme")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_04, CONDIC_NORMALIZAR))

        cls.l_alm_02_b_05 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme02_05"], descricao="[SE]  Relé de Proteção 59N - Trip")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_05, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_07, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_08, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_11, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_12, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_02_b_13, CONDIC_NORMALIZAR))

        cls.l_alm_03_b_00 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme03_00"], descricao="[SE]  Disjuntor 52L - Falha na Abertura")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_00, CONDIC_INDISPONIBILIZAR))

        cls.l_alm_03_b_01 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme03_01"], descricao="[SE]  Disjuntor 52L - Falha no Fechamento")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_01, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_02, CONDIC_INDISPONIBILIZAR))

        cls.l_alm_03_b_03 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme03_03"], descricao="[SE]  Disjuntor 52L - Falta Tensão Vcc")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_03, CONDIC_NORMALIZAR))

        cls.l_alm_03_b_04 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme03_04"], descricao="[SE]  Disjuntor 52L - Mola Descarregada")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_04, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_05, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_06, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_07, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_03_b_08, CONDIC_NORMALIZAR))

        cls.l_alm_05_b_02 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme05_02"], descricao="[SE]  Trafo Elevador - Alarme Relé Buchholz")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_02, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_03, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_04, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_05, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_06, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_07, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_08, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_09, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_10, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_11, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_12, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_13, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_05_b_14, CONDIC_NORMALIZAR))

        cls.l_alm_09_b_07 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme09_07"], descricao="[SE]  PACP-SE - Sensor de Fumaça Atuado")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_09_b_07, CONDIC_INDISPONIBILIZAR))

        cls.l_alm_09_b_08 = lei.LeituraModbusBit(cls.clp["SA"], REG_SE["Alarme09_08"], descricao="[SE]  PACP-SE - Sensor de Fumaça Desconectado")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_09_b_08, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_12_b_03, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_14_b_07, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_04, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_05, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_06, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_07, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_08, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_16_b_09, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_18_b_04, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_18_b_05, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_18_b_13, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_18_b_14, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_18_b_15, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_00, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_01, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_02, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_03, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_04, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_05, CONDIC_NORMALIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_19_b_15, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_00, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_01, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_02, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_03, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_04, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_05, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_20_b_15, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_21_b_00, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_alm_21_b_01, CONDIC_INDISPONIBILIZAR))

        cls.l_dj_02 = lei.LeituraModbus(cls.clp["SA"], REG_SE["DJ_02"], descricao="[SE]  PACP-SE - Alimentação Circuitos de Comando - Disj. Q125.0")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_02, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_04, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_07, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_08, CONDIC_INDISPONIBILIZAR))

        cls.l_dj_24 = lei.LeituraModbus(cls.clp["SA"], REG_SE["DJ_24"], descricao="[SE]  PDSA-CC - Alimentação do Painel PDSA-CA - Disj. Q125.3")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_24, CONDIC_INDISPONIBILIZAR))
        ...
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_28, CONDIC_INDISPONIBILIZAR))

        cls.l_dj_65 = lei.LeituraModbus(cls.clp["SA"], REG_SE["DJ_65"], descricao="[SE]  PDSA-CA - Alimentação 125Vcc Principal - Disj. Q125.0")
        dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_65, CONDIC_INDISPONIBILIZAR))
        ...
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_19, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_20))
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_20, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_19))
        ...
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_21, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_22))
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_22, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_21))
        ...
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_99, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_100))
        # dct_se['condicionadores'].append(c.CondicionadorBase(cls.l_dj_100, CONDIC_INDISPONIBILIZAR, leitura_conjunta=cls.l_dj_99))
