...
class ExternoNativo:
    def __init__(self, cliente: OpcDa | None = ...) -> ...:
...
class NativoExterno(ExternoNativo):
...
class Conversor(NativoExterno, ExternoNativo):
    def __init__(self, dados, opc) -> None:
        super().__init__(dados, opc)
