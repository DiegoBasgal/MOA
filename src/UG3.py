...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        # CX Espiral
        self.leitura_caixa_espiral = LeituraModbus("Gerador {} - Caixa espiral".format(self.id),self.clp,REG_UG3_EntradasAnalogicas_MRR_PressK1CaixaExpiral_MaisCasas,escala=0.01,op = 4)
        base = 16.1
        limite = 15.5
