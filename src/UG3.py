...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        self.leitura_CD_EmergenciaViaSuper = LeituraModbusCoil("CD_EmergenciaViaSuper", self.clp["UG3"], REG_UG3_CD_EmergenciaViaSuper,)
        ...
        self.leitura_ED_ReleBloqA86HAtuado = LeituraModbusCoil("ED_ReleBloqA86HAtuado", self.clp["UG3"], REG_UG3_ED_ReleBloqA86HAtuado)
        ...
        self.leitura_ED_ReleBloqA86MAtuado = LeituraModbusCoil("ED_ReleBloqA86MAtuado", self.clp["UG3"], REG_UG3_ED_ReleBloqA86MAtuado)
        ...
        self.leitura_RD_700G_Trip = LeituraModbusCoil("RD_700G_Trip",self.clp["UG3"],REG_UG3_RD_700G_Trip,)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        self.leitura_ED_FreioPastilhaGasta = LeituraModbusCoil( "ED_FreioPastilhaGasta", self.clp["UG3"], REG_UG3_ED_FreioPastilhaGasta )
        self.leitura_ED_FiltroPresSujo75Troc = LeituraModbusCoil( "ED_FiltroPresSujo75Troc", self.clp["UG3"], REG_UG3_ED_FiltroPresSujo75Troc )
        self.leitura_ED_FiltroRetSujo75Troc = LeituraModbusCoil( "ED_FiltroRetSujo75Troc", self.clp["UG3"], REG_UG3_ED_FiltroRetSujo75Troc )
        self.leitura_ED_UHLMFilt1PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt1PresSujo75Troc", self.clp["UG3"], REG_UG3_ED_UHLM_Filt1PresSujo75Troc )
        self.leitura_ED_UHLMFilt2PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt2PresSujo75Troc", self.clp["UG3"], REG_UG3_ED_UHLM_Filt2PresSujo75Troc )
        self.leitura_ED_FiltroPressaoBbaMecSj75 = LeituraModbusCoil( "ED_FiltroPressaoBbaMecSj75", self.clp["UG3"], REG_UG3_ED_FiltroPressaoBbaMecSj75 )
        self.leitura_ED_TripPartRes = LeituraModbusCoil( "ED_TripPartRes", self.clp["UG3"], REG_UG3_ED_TripPartRes )
        self.leitura_ED_FreioCmdRemoto = LeituraModbusCoil( "ED_FreioCmdRemoto", self.clp["UG3"], REG_UG3_ED_FreioCmdRemoto )
        self.leitura_ED_QCAUG3_Remoto = LeituraModbusCoil( "ED_QCAUG3_Remoto", self.clp["UG3"], REG_UG3_ED_QCAUG3_Remoto )
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def acionar_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG3"].write_single_coil(
    ...
    def remover_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG3"].write_single_coil(UG[f"REG_UG{self.id}_CD_ResetGeral"], 1)
            response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetReleBloq86H, 1)
            response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetReleBloq86M, 1)
            response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetRele700G, 1)
            ...
            response = self.clp["UG3"].write_single_coil(REG_UG3_ED_ReleBloqA86HAtuado, 0)
            response = self.clp["UG3"].write_single_coil(REG_UG3_ED_ReleBloqA86MAtuado, 0)
            response = self.clp["UG3"].write_single_coil(REG_UG3_RD_700G_Trip, 0)
        except:
            #! TODO Tratar exceptions
            return False
        else:
    ...
    def remover_trip_eletrico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG3"].write_single_coil(REG_UG3_CD_Cala_Sirene, 1)
    ...
    def partir(self) -> bool:
        ...
        try:
            ...
            if not self.clp["UG3"].read_discrete_inputs(REG_UG3_COND_PART, 1)[0]:
                ...
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetReleBloq86H, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetReleBloq86M, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetReleRT, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_ResetRV, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_IniciaPartida, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_Cala_Sirene, 1)
            else:
    ...
    def parar(self) -> bool:
        ...
        try:
            if not self.etapa_atual == UNIDADE_PARADA:
                ...
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_AbortaPartida, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_AbortaSincronismo, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_IniciaParada, 1)
                response = self.clp["UG3"].write_single_coil(REG_UG3_CD_Cala_Sirene, 1)
