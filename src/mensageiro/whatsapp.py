...
class WhatsApp:
    ...
    def verificar_saldo(cls):
        ...
        if saldo <= 100:
            WhatsApp.enviar_mensagem('120363285166903476@g.us', f'Atenção o saldo de mensagens está a baixo de 100! Saldo atual: {saldo}')
    ...
    def envio_grupo(mensagem):
        ...
        payload = {"number": "120363285166903476@g.us",
                  "message": f"{mensagem}"}
