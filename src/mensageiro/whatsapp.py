...
class WhatsApp:
    ...
    def verificar_saldo(cls) -> "dict":
        ...
        if saldo <= 100:
            WhatsApp.enviar_mensagem('120363253772108768@g.us', f'Atenção o saldo de mensagens está a baixo de 100! Saldo atual: {saldo}')
    ...
    def envio_grupo(mensagem: "str") -> "dict":
        ...
        payload = {"number": "120363253772108768@g.us",
                  "message": f"{mensagem}"}
