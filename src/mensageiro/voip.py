    ...
    if voz_habilitado:
        ...
        for contato in lista_de_contatos:
            ...
            data = {
                ...
                "audios": [
                    {
                        "audio": "Atenção! Houve um acionamento de emergência na PCH Covó, por favor verificar a situação. Atenção! Houve um acionamento de emergência na PCH Covó, por favor verificar a situação.",
                        "positionAudio": 1,
                    }
                ],
                "dtmfs": [],
