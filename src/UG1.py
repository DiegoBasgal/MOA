...
class UnidadeDeGeracao1(UnidadeDeGeracao):
    def __init__(self, id, cfg, db, con):
        ...
        C1 = LeituraModbusCoil(
            ...
            registrador=REG_UG1_ED_DisjGeradorFechado,
        )
        C2 = LeituraModbusCoil(
            descr="MXR_PartindoEmAuto",
            modbus_client=self.clp_ug1,
            registrador=REG_UG1_RD_ParandoEmAuto,
        )
        C3 = LeituraModbusCoil(
            descr="MXR_PartindoEmAuto",
            modbus_client=self.clp_ug1,
            registrador=REG_UG1_ED_RV_MaquinaParada,
        )
        C4 = LeituraModbusCoil(
            descr="MXR_PartindoEmAuto",
            modbus_client=self.clp_ug1,
            registrador=REG_UG1_RD_PartindoEmAuto,
        )
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        # R
        self.leitura_temperatura_fase_R = LeituraModbus("Temperatura fase R",self.clp_ug1,REG_UG1_RA_Temperatura_01,op=4,)
        base, limite = 100, 200
        ...
        # S
        self.leitura_temperatura_fase_S = LeituraModbus("Temperatura fase s",self.clp_ug1,REG_UG1_RA_Temperatura_02,op=4,)
        base, limite = 100, 200
        ...
        # T
        self.leitura_temperatura_fase_T = LeituraModbus("Temperatura fase T",self.clp_ug1,REG_UG1_RA_Temperatura_03,op=4,)
        base, limite = 100, 200
        ...
        # Nucleo estator
        self.leitura_temperatura_nucleo = LeituraModbus("Temperatura núcelo do estator",self.clp_ug1,REG_UG1_RA_Temperatura_04,op=4,)
        base, limite = 100, 200
        ...
        # MRD 1
        self.leitura_temperatura_mrd1 = LeituraModbus("Temperatura mancal radial dianteiro",self.clp_ug1,REG_UG1_RA_Temperatura_05,op=4,)
        base, limite = 100, 200
        ...
        # MRT 1
        self.leitura_temperatura_mrt1 = LeituraModbus("Temperatura mancal radial traseiro",self.clp_ug1,REG_UG1_RA_Temperatura_06,op=4,)
        base, limite = 100, 200
        ...
        # MRD 2
        self.leitura_temperatura_mrd2 = LeituraModbus("Temperatura mancal radial dianteiro 2",self.clp_ug1,REG_UG1_RA_Temperatura_07,op=4,)
        base, limite = 100, 200
        ...
        # MRT 2
        self.leitura_temperatura_mrt2 = LeituraModbus("Temperatura mancal radial traseiro 2",self.clp_ug1,REG_UG1_RA_Temperatura_08,op=4,)
        base, limite = 100, 200
        ...
        # Saída de ar
        self.leitura_temperatura_saida_de_ar = LeituraModbus("Saída de ar",self.clp_ug1,REG_UG1_RA_Temperatura_10,op=4,)
        base, limite = 100, 200
        ...
        # Mancal Guia Radial
        self.leitura_temperatura_guia_radial = LeituraModbus("Mancal Guia Radial",self.clp_ug1,REG_UG1_EA_TempMcGuiaRadial,)
        base, limite = 100, 200
        ...
        # Mancal Guia escora
        self.leitura_temperatura_guia_escora = LeituraModbus("Mancal Guia escora",self.clp_ug1,REG_UG1_EA_TempMcGuiaEscora,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_guia_contra_escora = LeituraModbus("Mancal Guia contra_escora",self.clp_ug1,REG_UG1_EA_TempMcGuiaContraEscora,)
        base, limite = 100, 200
        ...
        # CX Espiral
        self.leitura_caixa_espiral = LeituraModbus("Caixa espiral",self.clp_ug1,REG_UG1_EA_PressK1CaixaExpiral_MaisCasas,escala=0.01 ,op = 4)
        base = 16.1
        limite = 15.5
        ...
        self.leitura_CD_EmergenciaViaSuper = LeituraModbusCoil("CD_EmergenciaViaSuper", self.clp_ug1, REG_UG1_CD_EmergenciaViaSuper,)
        x = self.leitura_CD_EmergenciaViaSuper
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_RD_TripEletrico = LeituraModbusCoil("RD_TripEletrico", self.clp_ug1, REG_UG1_RD_TripEletrico,)
        x = self.leitura_RD_TripEletrico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_ReleBloqA86MAtuado = LeituraModbusCoil("ReleBloqA86MAtuado", self.clp_ug1, REG_UG1_ED_ReleBloqA86MAtuado)
        ...
        self.leitura_ReleBloqA86HAtuado = LeituraModbusCoil("ReleBloqA86HAtuado", self.clp_ug1, REG_UG1_ED_ReleBloqA86HAtuado)
        ...
        self.leitura_SEL700G_Atuado = LeituraModbusCoil("SEL700G_Atuado", self.clp_ug1, REG_UG1_ED_SEL700G_Atuado)
        x = self.leitura_SEL700G_Atuado
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RV_Trip = LeituraModbusCoil("RV_Trip", self.clp_ug1, REG_UG1_ED_RV_Trip)
        x = self.leitura_RV_Trip
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RD_TripMecanico = LeituraModbusCoil("RD_TripMecanico", self.clp_ug1, REG_UG1_RD_TripMecanico,)
        x = self.leitura_RD_TripMecanico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RD_700G_Trip = LeituraModbusCoil("RD_700G_Trip", self.clp_ug1, REG_UG1_RD_700G_Trip,)
        x = self.leitura_RD_700G_Trip
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_AVR_Trip = LeituraModbusCoil("AVR_Trip", self.clp_ug1, REG_UG1_ED_AVR_Trip)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        self.leitura_ED_SA_FalhaDisjTPsSincrG1 = LeituraModbusCoil("ED_SA_FalhaDisjTPsSincrG1",self.clp_sa,REG_SA_ED_SA_FalhaDisjTPsSincrG1,)
        ...
        self.leitura_ED_ValvBorbTravada = LeituraModbusCoil( "ED_ValvBorbTravada", self.clp_ug1, REG_UG1_ED_ValvBorbTravada )
        x = self.leitura_ED_ValvBorbTravada
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHRV_TripBomba2 = LeituraModbusCoil( "ED_UHRV_TripBomba2", self.clp_ug1, REG_UG1_ED_UHRV_TripBomba2 )
        x = self.leitura_ED_UHRV_TripBomba2
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHRV_TripBomba1 = LeituraModbusCoil( "ED_UHRV_TripBomba1", self.clp_ug1, REG_UG1_ED_UHRV_TripBomba1 )
        x = self.leitura_ED_UHRV_TripBomba1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHRV_NivOleominimoPos36 = LeituraModbusCoil( "ED_UHRV_NivOleominimoPos36", self.clp_ug1, REG_UG1_ED_UHRV_NivOleominimoPos36 )
        x = self.leitura_ED_UHRV_NivOleominimoPos36
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHRV_NivOleoCriticoPos35 = LeituraModbusCoil( "ED_UHRV_NivOleoCriticoPos35", self.clp_ug1, REG_UG1_ED_UHRV_NivOleoCriticoPos35 )
        x = self.leitura_ED_UHRV_NivOleoCriticoPos35
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_Filt2PresSujo100Sujo = LeituraModbusCoil( "ED_UHLM_Filt2PresSujo100Sujo", self.clp_ug1, REG_UG1_ED_UHLM_Filt2PresSujo100Sujo )
        x = self.leitura_ED_UHLM_Filt2PresSujo100Sujo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_Filt1PresSujo100Sujo = LeituraModbusCoil( "ED_UHLM_Filt1PresSujo100Sujo", self.clp_ug1, REG_UG1_ED_UHLM_Filt1PresSujo100Sujo )
        x = self.leitura_ED_UHLM_Filt1PresSujo100Sujo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_TripBomba2 = LeituraModbusCoil( "ED_UHLM_TripBomba2", self.clp_ug1, REG_UG1_ED_UHLM_TripBomba2 )
        x = self.leitura_ED_UHLM_TripBomba2
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_TripBomba1 = LeituraModbusCoil( "ED_UHLM_TripBomba1", self.clp_ug1, REG_UG1_ED_UHLM_TripBomba1 )
        x = self.leitura_ED_UHLM_TripBomba1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_NivelminOleo = LeituraModbusCoil( "ED_UHLM_NivelminOleo", self.clp_ug1, REG_UG1_ED_UHLM_NivelminOleo )
        x = self.leitura_ED_UHLM_NivelminOleo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_NivelCritOleo = LeituraModbusCoil( "ED_UHLM_NivelCritOleo", self.clp_ug1, REG_UG1_ED_UHLM_NivelCritOleo )
        x = self.leitura_ED_UHLM_NivelCritOleo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_FluxoMcTras = LeituraModbusCoil( "ED_UHLM_FluxoMcTras", self.clp_ug1, REG_UG1_ED_UHLM_FluxoMcTras )
        x = self.leitura_ED_UHLM_FluxoMcTras
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_FluxoMcDianteiro = LeituraModbusCoil( "ED_UHLM_FluxoMcDianteiro", self.clp_ug1, REG_UG1_ED_UHLM_FluxoMcDianteiro )
        x = self.leitura_ED_UHLM_FluxoMcDianteiro
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_FaltaPressTroc = LeituraModbusCoil( "ED_UHLM_FaltaPressTroc", self.clp_ug1, REG_UG1_ED_UHLM_FaltaPressTroc )
        x = self.leitura_ED_UHLM_FaltaPressTroc
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_UHLM_FaltaFluxTroc = LeituraModbusCoil( "ED_UHLM_FaltaFluxTroc", self.clp_ug1, REG_UG1_ED_UHLM_FaltaFluxTroc )
        x = self.leitura_ED_UHLM_FaltaFluxTroc
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_TripAlimPainelFreio = LeituraModbusCoil( "ED_TripAlimPainelFreio", self.clp_ug1, REG_UG1_ED_TripAlimPainelFreio )
        x = self.leitura_ED_TripAlimPainelFreio
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_SobreVeloMecPos18 = LeituraModbusCoil( "ED_SobreVeloMecPos18", self.clp_ug1, REG_UG1_ED_SobreVeloMecPos18 )
        x = self.leitura_ED_SobreVeloMecPos18
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_SEL700G_FalhaInterna = LeituraModbusCoil( "ED_SEL700G_FalhaInterna", self.clp_ug1, REG_UG1_ED_SEL700G_FalhaInterna )
        x = self.leitura_ED_SEL700G_FalhaInterna
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_UHRV_FalhaAcionBbaM2 = LeituraModbusCoil( "RD_UHRV_FalhaAcionBbaM2", self.clp_ug1, REG_UG1_RD_UHRV_FalhaAcionBbaM2, )
        x = self.leitura_RD_UHRV_FalhaAcionBbaM2
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_UHRV_FalhaAcionBbaM1 = LeituraModbusCoil( "RD_UHRV_FalhaAcionBbaM1", self.clp_ug1, REG_UG1_RD_UHRV_FalhaAcionBbaM1, )
        x = self.leitura_RD_UHRV_FalhaAcionBbaM1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_UHLM_FalhaAcionBbaM2 = LeituraModbusCoil( "RD_UHLM_FalhaAcionBbaM2", self.clp_ug1, REG_UG1_RD_UHLM_FalhaAcionBbaM2, )
        x = self.leitura_RD_UHLM_FalhaAcionBbaM2
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_UHLM_FalhaAcionBbaM1 = LeituraModbusCoil( "RD_UHLM_FalhaAcionBbaM1", self.clp_ug1, REG_UG1_RD_UHLM_FalhaAcionBbaM1, )
        x = self.leitura_RD_UHLM_FalhaAcionBbaM1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripVibr2 = LeituraModbusCoil( "RD_TripVibr2", self.clp_ug1, REG_UG1_RD_TripVibr2, )
        x = self.leitura_RD_TripVibr2
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripVibr1 = LeituraModbusCoil( "RD_TripVibr1", self.clp_ug1, REG_UG1_RD_TripVibr1, )
        x = self.leitura_RD_TripVibr1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempUHRV = LeituraModbusCoil( "RD_TripTempUHRV", self.clp_ug1, REG_UG1_RD_TripTempUHRV, )
        x = self.leitura_RD_TripTempUHRV
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempUHLM = LeituraModbusCoil( "RD_TripTempUHLM", self.clp_ug1, REG_UG1_RD_TripTempUHLM, )
        x = self.leitura_RD_TripTempUHLM
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempMcGuiaRadial = LeituraModbusCoil( "RD_TripTempMcGuiaRadial", self.clp_ug1, REG_UG1_RD_TripTempMcGuiaRadial, )
        x = self.leitura_RD_TripTempMcGuiaRadial
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempMcGuiaEscora = LeituraModbusCoil( "RD_TripTempMcGuiaEscora", self.clp_ug1, REG_UG1_RD_TripTempMcGuiaEscora, )
        x = self.leitura_RD_TripTempMcGuiaEscora
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempMcGuiaContraEscora = ( LeituraModbusCoil( "RD_TripTempMcGuiaContraEscora", self.clp_ug1, REG_UG1_RD_TripTempMcGuiaContraEscora, ) )
        x = self.leitura_RD_TripTempMcGuiaContraEscora
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_TripTempGaxeteiro = LeituraModbusCoil( "RD_TripTempGaxeteiro", self.clp_ug1, REG_UG1_RD_TripTempGaxeteiro, )
        x = self.leitura_RD_TripTempGaxeteiro
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_Q_Negativa = LeituraModbusCoil( "RD_Q_Negativa", self.clp_ug1, REG_UG1_RD_Q_Negativa, )
        x = self.leitura_RD_Q_Negativa
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_FalhaIbntDisjGer = LeituraModbusCoil( "RD_FalhaIbntDisjGer", self.clp_ug1, REG_UG1_RD_FalhaIbntDisjGer, )
        x = self.leitura_RD_FalhaIbntDisjGer
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_FalhaAcionFechaValvBorb = LeituraModbusCoil( "RD_FalhaAcionFechaValvBorb", self.clp_ug1, REG_UG1_RD_FalhaAcionFechaValvBorb, )
        x = self.leitura_RD_FalhaAcionFechaValvBorb
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_CLP_Falha = LeituraModbusCoil( "RD_CLP_Falha", self.clp_ug1, REG_UG1_RD_CLP_Falha, )
        x = self.leitura_RD_CLP_Falha
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_RD_Remota_Falha = LeituraModbusCoil( "RD_Remota_Falha", self.clp_ug1, REG_UG1_RD_Remota_Falha, )
        x = self.leitura_RD_Remota_Falha
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_QCAUG_TripDisjAgrup = LeituraModbusCoil( "ED_QCAUG_TripDisjAgrup", self.clp_ug1, REG_UG1_ED_QCAUG_TripDisjAgrup )
        x = self.leitura_ED_QCAUG_TripDisjAgrup
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_QCAUG_TripDisj52A1 = LeituraModbusCoil( "ED_QCAUG_TripDisj52A1", self.clp_ug1, REG_UG1_ED_QCAUG_TripDisj52A1 )
        x = self.leitura_ED_QCAUG_TripDisj52A1
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_QCAUG_Falha380VcaPainel = LeituraModbusCoil( "ED_QCAUG_Falha380VcaPainel", self.clp_ug1, REG_UG1_ED_QCAUG_Falha380VcaPainel )
        x = self.leitura_ED_QCAUG_Falha380VcaPainel
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_NORMALIZAR, x) )

        self.leitura_ED_PalhetasDesal = LeituraModbusCoil( "ED_PalhetasDesal", self.clp_ug1, REG_UG1_ED_PalhetasDesal )
        x = self.leitura_ED_PalhetasDesal
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_NivelMAltoPocoDren = LeituraModbusCoil( "ED_NivelMAltoPocoDren", self.clp_ug1, REG_UG1_ED_NivelMAltoPocoDren )
        x = self.leitura_ED_NivelMAltoPocoDren
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FreioSemEnergia = LeituraModbusCoil( "ED_FreioSemEnergia", self.clp_ug1, REG_UG1_ED_FreioSemEnergia )
        x = self.leitura_ED_FreioSemEnergia
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FreioFiltroSaturado = LeituraModbusCoil( "ED_FreioFiltroSaturado", self.clp_ug1, REG_UG1_ED_FreioFiltroSaturado )
        x = self.leitura_ED_FreioFiltroSaturado
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FiltroRetSujo100Sujo = LeituraModbusCoil( "ED_FiltroRetSujo100Sujo", self.clp_ug1, REG_UG1_ED_FiltroRetSujo100Sujo )
        x = self.leitura_ED_FiltroRetSujo100Sujo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FiltroPresSujo100Sujo = LeituraModbusCoil( "ED_FiltroPresSujo100Sujo", self.clp_ug1, REG_UG1_ED_FiltroPresSujo100Sujo )
        x = self.leitura_ED_FiltroPresSujo100Sujo
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FiltroPressaoBbaMecSj100 = LeituraModbusCoil( "ED_FiltroPressaoBbaMecSj100", self.clp_ug1, REG_UG1_ED_FiltroPressaoBbaMecSj100 )
        x = self.leitura_ED_FiltroPressaoBbaMecSj100
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FaltaFluxoOleoMc = LeituraModbusCoil( "ED_FaltaFluxoOleoMc", self.clp_ug1, REG_UG1_ED_FaltaFluxoOleoMc )
        x = self.leitura_ED_FaltaFluxoOleoMc
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_Falta125VccCom = LeituraModbusCoil( "ED_Falta125VccCom", self.clp_ug1, REG_UG1_ED_Falta125VccCom )
        x = self.leitura_ED_Falta125VccCom
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_Falta125VccAlimVal = LeituraModbusCoil( "ED_Falta125VccAlimVal", self.clp_ug1, REG_UG1_ED_Falta125VccAlimVal )
        x = self.leitura_ED_Falta125VccAlimVal
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_Falta125Vcc = LeituraModbusCoil( "ED_Falta125Vcc", self.clp_ug1, REG_UG1_ED_Falta125Vcc )
        x = self.leitura_ED_Falta125Vcc
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FalhaDisjTpsProt = LeituraModbusCoil( "ED_FalhaDisjTpsProt", self.clp_ug1, REG_UG1_ED_FalhaDisjTpsProt )
        x = self.leitura_ED_FalhaDisjTpsProt
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_AVR_ED_FalhaInterna = LeituraModbusCoil( "ED_AVR_FalhaInterna", self.clp_ug1, REG_UG1_ED_AVR_FalhaInterna )
        x = self.leitura_AVR_ED_FalhaInterna
        self.condicionadores.append( CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x) )

        self.leitura_ED_FreioPastilhaGasta = LeituraModbusCoil( "ED_FreioPastilhaGasta", self.clp_ug1, REG_UG1_ED_FreioPastilhaGasta )
        self.leitura_ED_FiltroPresSujo75Troc = LeituraModbusCoil( "ED_FiltroPresSujo75Troc", self.clp_ug1, REG_UG1_ED_FiltroPresSujo75Troc )
        self.leitura_ED_FiltroRetSujo75Troc = LeituraModbusCoil( "ED_FiltroRetSujo75Troc", self.clp_ug1, REG_UG1_ED_FiltroRetSujo75Troc )
        self.leitura_ED_UHLMFilt1PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt1PresSujo75Troc", self.clp_ug1, REG_UG1_ED_UHLM_Filt1PresSujo75Troc )
        self.leitura_ED_UHLMFilt2PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt2PresSujo75Troc", self.clp_ug1, REG_UG1_ED_UHLM_Filt2PresSujo75Troc )
        self.leitura_ED_FiltroPressaoBbaMecSj75 = LeituraModbusCoil( "ED_FiltroPressaoBbaMecSj75", self.clp_ug1, REG_UG1_ED_FiltroPressaoBbaMecSj75 )
        self.leitura_ED_TripPartRes = LeituraModbusCoil( "ED_TripPartRes", self.clp_ug1, REG_UG1_ED_TripPartRes )
        self.leitura_ED_FreioCmdRemoto = LeituraModbusCoil( "ED_FreioCmdRemoto", self.clp_ug1, REG_UG1_ED_FreioCmdRemoto )
        self.leitura_ED_QCAUG1_Remoto = LeituraModbusCoil( "ED_QCAUG1_Remoto", self.clp_ug1, REG_UG1_ED_QCAUG1_Remoto )
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def acionar_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp_ug1.write_single_coil(
                REG_UG1_CD_EmergenciaViaSuper, 1
            )
        except:
    ...
    def remover_trip_logico(self) -> bool:
        ...
        """
        try:
            logger.debug(f"[UG{self.id}] Removendo sinal (via rede) de TRIP.")
            response = self.clp_ug1.write_single_coil(UG[f"REG_UG{self.id}_CD_ResetGeral"], 1)
            response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetReleBloq86H, 1)
            response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetReleBloq86M, 1)
            response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetRele700G, 1)
            ...
            response = self.clp_ug1.write_single_coil(REG_UG1_ED_ReleBloqA86HAtuado, 0)
            response = self.clp_ug1.write_single_coil(REG_UG1_ED_ReleBloqA86MAtuado, 0)
            response = self.clp_ug1.write_single_coil(REG_UG1_RD_700G_Trip, 0)
    ...
    def remover_trip_eletrico(self) -> bool:
        ...
        try:
            ...
            response = self.clp_ug1.write_single_coil(REG_UG1_CD_Cala_Sirene, 1)

            if self.clp_sa.read_coils(REG_SA_CD_Liga_DJ1)[0] == 0:
                logger.debug("Comando recebido da UG1 - Fechando Dj52L")
                self.con.fechaDj52L()
    ...
    def partir(self) -> bool:
        ...
        try:
            ...
            if not self.clp_ug1.read_discrete_inputs(REG_UG1_COND_PART,1)[0]:
                ...
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetReleBloq86H, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetReleBloq86M, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetReleRT, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_ResetRV, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_IniciaPartida, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_Cala_Sirene, 1)
            else:
    ...
    def parar(self) -> bool:
        ...
        try:
            if not self.etapa_atual == UNIDADE_PARADA:
                ...
                response = False
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_AbortaPartida, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_AbortaSincronismo, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_IniciaParada, 1)
                response = self.clp_ug1.write_single_coil(REG_UG1_CD_Cala_Sirene, 1)
    ...
    def leituras_por_hora(self):
        ...
        if self.leitura_ED_QCAUG1_Remoto.valor == 0 and self.QCAUGRemoto==True:
            logger.debug(f"[UG{self.id}] O compressor da UG saiu do modo remoto, favor analisar a situação.")
            self.QCAUGRemoto = False
        elif self.leitura_ED_QCAUG1_Remoto.valor == 1 and self.QCAUGRemoto==False:
            self.QCAUGRemoto = True
