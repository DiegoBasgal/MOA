...
class UnidadeDeGeracao1(UnidadeDeGeracao):
    def __init__(
        ...
        self.relé_de_proteção_sel700g_subfreq= LeituraModbusBit('11.13 - Relé de Proteção SEL700G - Subfrequência', self.clp, REG_UG1_Alarme11, 13)
        x = self.relé_de_proteção_sel700g_subfreq
