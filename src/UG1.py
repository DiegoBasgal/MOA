...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        # R
        self.leitura_temperatura_fase_R = LeituraModbus("Temperatura fase R",self.clp["UG1"],REG_UG1_RA_Temperatura_01,op=4,)
        base, limite = 100, 200
        ...
        # S
        self.leitura_temperatura_fase_S = LeituraModbus("Temperatura fase s",self.clp["UG1"],REG_UG1_RA_Temperatura_02,op=4,)
        base, limite = 100, 200
        ...
        # T
        self.leitura_temperatura_fase_T = LeituraModbus("Temperatura fase T",self.clp["UG1"],REG_UG1_RA_Temperatura_03,op=4,)
        base, limite = 100, 200
        ...
        # Nucleo estator
        self.leitura_temperatura_nucleo = LeituraModbus("Temperatura núcelo do estator",self.clp["UG1"],REG_UG1_RA_Temperatura_04,op=4,)
        base, limite = 100, 200
        ...
        # MRD 1
        self.leitura_temperatura_mrd1 = LeituraModbus("Temperatura mancal radial dianteiro",self.clp["UG1"],REG_UG1_RA_Temperatura_05,op=4,)
        base, limite = 100, 200
        ...
        # MRT 1
        self.leitura_temperatura_mrt1 = LeituraModbus("Temperatura mancal radial traseiro",self.clp["UG1"],REG_UG1_RA_Temperatura_06,op=4,)
        base, limite = 100, 200
        ...
        # MRD 2
        self.leitura_temperatura_mrd2 = LeituraModbus("Temperatura mancal radial dianteiro 2",self.clp["UG1"],REG_UG1_RA_Temperatura_07,op=4,)
        base, limite = 100, 200
        ...
        # MRT 2
        self.leitura_temperatura_mrt2 = LeituraModbus("Temperatura mancal radial traseiro 2",self.clp["UG1"],REG_UG1_RA_Temperatura_08,op=4,)
        base, limite = 100, 200
        ...
        # Saída de ar
        self.leitura_temperatura_saida_de_ar = LeituraModbus("Saída de ar",self.clp["UG1"],REG_UG1_RA_Temperatura_10,op=4,)
        base, limite = 100, 200
        ...
        # Mancal Guia Radial
        self.leitura_temperatura_guia_radial = LeituraModbus("Mancal Guia Radial",self.clp["UG1"],REG_UG1_EA_TempMcGuiaRadial,)
        base, limite = 100, 200
        ...
        # Mancal Guia escora
        self.leitura_temperatura_guia_escora = LeituraModbus("Mancal Guia escora",self.clp["UG1"],REG_UG1_EA_TempMcGuiaEscora,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_guia_contra_escora = LeituraModbus("Mancal Guia contra_escora",self.clp["UG1"],REG_UG1_EA_TempMcGuiaContraEscora,)
        base, limite = 100, 200
        ...
        # CX Espiral
        self.leitura_caixa_espiral = LeituraModbus("Caixa espiral",self.clp["UG1"],REG_UG1_EA_PressK1CaixaExpiral_MaisCasas,escala=0.01 ,op = 4)
        base = 16.1
        limite = 15.5
        ...
        self.leitura_CD_EmergenciaViaSuper = LeituraModbusCoil("CD_EmergenciaViaSuper", self.clp["UG1"], REG_UG1_CD_EmergenciaViaSuper,)
        x = self.leitura_CD_EmergenciaViaSuper
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_RD_TripEletrico = LeituraModbusCoil("RD_TripEletrico", self.clp["UG1"], REG_UG1_RD_TripEletrico,)
        x = self.leitura_RD_TripEletrico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_ReleBloqA86MAtuado = LeituraModbusCoil("ReleBloqA86MAtuado", self.clp["UG1"], REG_UG1_ED_ReleBloqA86MAtuado)
        ...
        self.leitura_ReleBloqA86HAtuado = LeituraModbusCoil("ReleBloqA86HAtuado", self.clp["UG1"], REG_UG1_ED_ReleBloqA86HAtuado)
        ...
        self.leitura_SEL700G_Atuado = LeituraModbusCoil("SEL700G_Atuado", self.clp["UG1"], REG_UG1_ED_SEL700G_Atuado)
        x = self.leitura_SEL700G_Atuado
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RV_Trip = LeituraModbusCoil("RV_Trip", self.clp["UG1"], REG_UG1_ED_RV_Trip)
        x = self.leitura_RV_Trip
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RD_TripMecanico = LeituraModbusCoil("RD_TripMecanico", self.clp["UG1"], REG_UG1_RD_TripMecanico,)
        x = self.leitura_RD_TripMecanico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RD_700G_Trip = LeituraModbusCoil("RD_700G_Trip", self.clp["UG1"], REG_UG1_RD_700G_Trip,)
        x = self.leitura_RD_700G_Trip
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_AVR_Trip = LeituraModbusCoil("AVR_Trip", self.clp["UG1"], REG_UG1_ED_AVR_Trip)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        self.leitura_ED_FreioPastilhaGasta = LeituraModbusCoil( "ED_FreioPastilhaGasta", self.clp["UG1"], REG_UG1_ED_FreioPastilhaGasta )
        self.leitura_ED_FiltroPresSujo75Troc = LeituraModbusCoil( "ED_FiltroPresSujo75Troc", self.clp["UG1"], REG_UG1_ED_FiltroPresSujo75Troc )
        self.leitura_ED_FiltroRetSujo75Troc = LeituraModbusCoil( "ED_FiltroRetSujo75Troc", self.clp["UG1"], REG_UG1_ED_FiltroRetSujo75Troc )
        self.leitura_ED_UHLMFilt1PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt1PresSujo75Troc", self.clp["UG1"], REG_UG1_ED_UHLM_Filt1PresSujo75Troc )
        self.leitura_ED_UHLMFilt2PresSujo75Troc = LeituraModbusCoil( "ED_UHLMFilt2PresSujo75Troc", self.clp["UG1"], REG_UG1_ED_UHLM_Filt2PresSujo75Troc )
        self.leitura_ED_FiltroPressaoBbaMecSj75 = LeituraModbusCoil( "ED_FiltroPressaoBbaMecSj75", self.clp["UG1"], REG_UG1_ED_FiltroPressaoBbaMecSj75 )
        self.leitura_ED_TripPartRes = LeituraModbusCoil( "ED_TripPartRes", self.clp["UG1"], REG_UG1_ED_TripPartRes )
        self.leitura_ED_FreioCmdRemoto = LeituraModbusCoil( "ED_FreioCmdRemoto", self.clp["UG1"], REG_UG1_ED_FreioCmdRemoto )
        self.leitura_ED_QCAUG1_Remoto = LeituraModbusCoil( "ED_QCAUG1_Remoto", self.clp["UG1"], REG_UG1_ED_QCAUG1_Remoto )
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def controle_cx_espiral(self):
        ...
        self.cx_controle_i = max(min(self.clp["MOA"].write_single_coil(self.cfg["cx_ki"] * self.erro_press_cx) + self.cx_controle_i, 1), 0)
        ...
        # implementação nova
        pot_aux = self.cfg["pot_maxima_alvo"] - self.clp["MOA"].write_single_coil(self.cfg["pot_maxima_usina"] - self.cfg["pot_maxima_alvo"])
    ...
    def acionar_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG1"].write_single_coil(
    ...
    def remover_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG1"].write_single_coil(UG[f"REG_UG{self.id}_CD_ResetGeral"], 1)
            response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetReleBloq86H, 1)
            response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetReleBloq86M, 1)
            response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetRele700G, 1)
            ...
            response = self.clp["UG1"].write_single_coil(REG_UG1_ED_ReleBloqA86HAtuado, 0)
            response = self.clp["UG1"].write_single_coil(REG_UG1_ED_ReleBloqA86MAtuado, 0)
            response = self.clp["UG1"].write_single_coil(REG_UG1_RD_700G_Trip, 0)
    ...
    def remover_trip_eletrico(self) -> bool:
        ...
        try:
            ...
            response = self.clp["UG1"].write_single_coil(REG_UG1_CD_Cala_Sirene, 1)
    ...
    def partir(self) -> bool:
        ...
        try:
            ...
            if not self.clp["UG1"].read_discrete_inputs(REG_UG1_COND_PART,1)[0]:
                ...
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetReleBloq86H, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetReleBloq86M, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetReleRT, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_ResetRV, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_IniciaPartida, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_Cala_Sirene, 1)
            else:
    ...
    def parar(self) -> bool:
        ...
        try:
            if not self.etapa_atual == UNIDADE_PARADA:
                ...
                response = False
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_AbortaPartida, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_AbortaSincronismo, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_IniciaParada, 1)
                response = self.clp["UG1"].write_single_coil(REG_UG1_CD_Cala_Sirene, 1)
