...
class UnidadeDeGeracao1(UnidadeDeGeracao):
    def __init__(self, id, cfg, clp, db, con):
        ...
        self.leitura_CD_EmergenciaViaSuper = LeituraModbusCoil("CD_EmergenciaViaSuper", self.clp["UG1"], UG["REG_UG1_CD_EmergenciaViaSuper"],)
        ...
        self.leitura_ReleBloqA86MAtuado = LeituraModbusCoil("ReleBloqA86MAtuado", self.clp["UG1"], UG["REG_UG1_ED_ReleBloqA86MAtuado"])
        ...
        self.leitura_ReleBloqA86HAtuado = LeituraModbusCoil("ReleBloqA86HAtuado", self.clp["UG1"], UG["REG_UG1_ED_ReleBloqA86HAtuado"])
        ...
        self.leitura_RD_700G_Trip = LeituraModbusCoil("RD_700G_Trip", self.clp["UG1"], UG["REG_UG1_RD_700G_Trip"],)
