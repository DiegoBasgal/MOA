...
class UnidadeDeGeracao1(UnidadeDeGeracao):
    ...
    def parar(self) -> bool:
        ...
        try:
            ...
            response = self.clp.write_single_register(REG_UG1_ComandosDigitais_MXW_AbortaPartida, 1)
            response = self.clp.write_single_register(REG_UG1_ComandosDigitais_MXW_AbortaSincronismo, 1)
