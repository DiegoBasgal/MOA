...
NIVEL_MAXIMORUM = 821.3
NIVEL_VERTIMENTO = 818
NIVEL_FUNDO_RESERVATORIO = 815
...
# Estados e etapas das Comportas Adufas
ADCP_DISPONIVEL = 0
ADCP_MANUAL = 1
ADCP_INDISPONIVEL = 2

ADCP_STR_DCT_ESTADO = {}
ADCP_STR_DCT_ESTADO[ADCP_DISPONIVEL] = "Disponível"
ADCP_STR_DCT_ESTADO[ADCP_MANUAL] = "Manual"
ADCP_STR_DCT_ESTADO[ADCP_INDISPONIVEL] = "Indisponível"
...
ADCP_STR_DCT_ETAPA = {}
ADCP_STR_DCT_ETAPA[ADCP_PARADA] = "Parada"
ADCP_STR_DCT_ETAPA[ADCP_ABRINDO] = "Abrindo"
ADCP_STR_DCT_ETAPA[ADCP_FECHANDO] = "Fechando"

ADCP_P_ABERTA = 0
ADCP_P_FECHADA = 1

ADCP_STR_DCT_ETAPA_P = {}
ADCP_STR_DCT_ETAPA_P[ADCP_P_ABERTA] = "Aberta"
ADCP_STR_DCT_ETAPA_P[ADCP_P_FECHADA] = "Fechada"
...
UG_STR_DCT_ETAPAS[UG_PARTINDO_PARANDO] = "Partindo/Parando"
...
AGN_ADCP1_FORCAR_ESTADO_DISPONIVEL = 501
AGN_ADCP1_FORCAR_ESTADO_INDISPONIVEL = 502

AGN_ADCP2_FORCAR_ESTADO_DISPONIVEL = 601
AGN_ADCP2_FORCAR_ESTADO_INDISPONIVEL = 602
...
AGN_STR_DICT[AGN_ADCP1_FORCAR_ESTADO_DISPONIVEL] = "AD CP1 - Forçar Estado Disponível"
AGN_STR_DICT[AGN_ADCP1_FORCAR_ESTADO_INDISPONIVEL] = "AD CP1 - Forçar Estado Indisponível"

AGN_STR_DICT[AGN_ADCP2_FORCAR_ESTADO_DISPONIVEL] = "AD CP2 - Forçar Estado Disponível"
AGN_STR_DICT[AGN_ADCP2_FORCAR_ESTADO_INDISPONIVEL] = "AD CP2 - Forçar Estado Indisponível"
