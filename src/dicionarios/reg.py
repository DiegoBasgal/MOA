...
REG_UG ={
    ...
    "UG2_CD_CMD_UHRV_MODO_AUTOMATICO":                  [12290, 0], # Coil -> Bit 00                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_MODO_MANUTENCAO":                  [12290, 1], # Coil -> Bit 01                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_1_LIGA":                     [12290, 2], # Coil -> Bit 02                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_1_DESLIGA":                  [12290, 3], # Coil -> Bit 03                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_2_LIGA":                     [12290, 4], # Coil -> Bit 04                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_2_DESLIGA":                  [12290, 5], # Coil -> Bit 05                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_1_PRINCIPAL":                [12290, 6], # Coil -> Bit 06                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHRV_BOMBA_2_PRINCIPAL":                [12290, 7], # Coil -> Bit 07                        (OP -> 0x15 Write Multiple Coils)

    "UG2_CD_CMD_UHLM":                                  12292,      # Coil                                  (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHLM_MODO_AUTOMATICO":                  [12292, 0], # Coil -> Bit 00                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHLM_MODO_MANUTENCAO":                  [12292, 1], # Coil -> Bit 01                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHLM_BOMBA_1_LIGA":                     [12292, 2], # Coil -> Bit 02                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_UHLM_BOMBA_1_DESLIGA":                  [12292, 3], # Coil -> Bit 03                        (OP -> 0x15 Write Multiple Coils)

    "UG2_CD_CMD_PARTIDA_PARADA":                        12294,      # Coil                                  (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_PARADA_TOTAL":                          [12294, 0], # Coil -> Bit 00                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_UHRV":                              [12294, 1], # Coil -> Bit 01                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_UHLM":                              [12294, 2], # Coil -> Bit 02                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_BORBOLETA":                         [12294, 5], # Coil -> Bit 05                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_RV":                                [12294, 7], # Coil -> Bit 07                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_RT":                                [12294, 8], # Coil -> Bit 08                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_SINCRONISMO":                           [12294, 9], # Coil -> Bit 09                        (OP -> 0x15 Write Multiple Coils)
    "UG2_CD_CMD_ATE_FILTRAGEM":                         [12294, 10],# Coil -> Bit 10                        (OP -> 0x15 Write Multiple Coils)
