...
REG_UG ={
    ...
    "UG1_RV_FALHA_1_PERDA_MED_VELOC_PRINCIPAL":         [68, 15],   # Input Register -> Bit 15              (OP -> 0x04 Read Input Registers - 3x)
    ...
    "UG2_ED_PRTVA_DISJUNTOR_TPS_SINCRO":                [12312, 6], # Holding Register -> Bit 06            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHRV_OLEO_NIVEL_MUITO_BAIXO":         [12312, 7], # Holding Register -> Bit 07            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHRV_FILTRO_OLEO_SUJO":               [12312, 8], # Holding Register -> Bit 08            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHRV_PRESSAO_CRITICA":                [12312, 9], # Holding Register -> Bit 09            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHRV_PRESSAO_FREIO":                  [12312, 10],# Holding Register -> Bit 10            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHLM_OLEO_NIVEL_MUITO_ALTO":          [12312, 12],# Holding Register -> Bit 12            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHLM_OLEO_NIVEL_MUITO_BAIXO":         [12312, 13],# Holding Register -> Bit 13            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHLM_PRESSAO_LINHA_LUBRIFICACAO":     [12312, 14],# Holding Register -> Bit 14            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHLM_FILTRO_OLEO_SUJO":               [12312, 15],# Holding Register -> Bit 15            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_UHLM_FLUXO_TROCADOR_CALOR":           [12312, 16],# Holding Register -> Bit 16            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_QBAG_ESCOVA_POLO_POSITIVO_DESGASTADA":[12312, 18],# Holding Register -> Bit 18            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_QBAG_ESCOVA_POLO_NEGATICO_DESGASTADA":[12312, 19],# Holding Register -> Bit 19            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_PSA_BLOQUEIO_86BTBF":                 [12312, 20],# Holding Register -> Bit 20            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_PSA_POCO_DRENAGEM_NIVEL_MUITO_ALTO":  [12312, 21],# Holding Register -> Bit 21            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_PSA_FILTRAGEM_PRESSAO_SAIDA":         [12312, 22],# Holding Register -> Bit 22            (OP -> 0x03 Read Holding Registers)
    "UG2_ED_PRTVA_PSA_DISJUNTOR_LINHA_FECHADO":         [12312, 23],# Holding Register -> Bit 23            (OP -> 0x03 Read Holding Registers)
