...
modbus = ModbusClient(host, port, unit_id, timeout, debug=verbose, auto_open=True, auto_close=True)
if read and write:
...
if read:
    ...
    if multiple == 1:
        ...
        for line in range(nlines):
            print("{:6d} : {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} {:>6d} : {:<6d} ".format(addr + line*10, *response[line*10:(line+1)*10], addr + line*10 + 9))