...
CFG = {
    ...
    "REG_PAINEL_LIDO": 12,
    "REG_MOA_IN_EMERG": 13,
    "REG_MOA_IN_HABILITA_AUTO": 14,
    "REG_MOA_IN_DESABILITA_AUTO": 15,
    "REG_MOA_OUT_EMERG": 16,
    "REG_MOA_OUT_TARGET_LEVEL": 17,
    "REG_MOA_OUT_SETPOINT": 18,
    "REG_MOA_IN_EMERG_UG1": 20,
    "REG_MOA_OUT_BLOCK_UG1": 21,
    "REG_MOA_OUT_ETAPA_UG1": 22,
    "REG_MOA_OUT_STATE_UG1": 23,
    "REG_MOA_IN_EMERG_UG2": 25,
    "REG_MOA_OUT_BLOCK_UG2": 26,
    "REG_MOA_OUT_STATE_UG2": 27,
    "REG_MOA_OUT_ETAPA_UG2": 28,
    "REG_MOA_IN_EMERG_UG3": 30,
    "REG_MOA_OUT_BLOCK_UG3": 31,
    "REG_MOA_OUT_STATE_UG3": 32,
    "REG_MOA_OUT_ETAPA_UG3": 33,
    "REG_MOA_IN_EMERG_UG4": 35,
    "REG_MOA_OUT_BLOCK_UG4": 36,
    "REG_MOA_OUT_STATE_UG4": 37,
    "REG_MOA_OUT_ETAPA_UG4": 38
}

VOIP = {
    "TDA_FalhaComum": False,
    "Disj_GDE_QCAP_Fechado": False,
    "BombasDngRemoto": True
}
...
UG = {
    ...
    "REG_UG1_EntradasAnalogicas_MRR_PressK1CaixaExpiral_MaisCasas": 34903, # Scale 0.01 - Op04 (Read Input Regs)
    ...
    "REG_UG1_ComandosDigitais_MXW_EmergenciaViaSuper": 34902, #antigo -> 4  # Op15 (Write multiple coils)
    ...
    "REG_UG1_EntradasAnalogicas_MRR_PressK1CaixaExpiral": 34903,  # Scale 0.1 - Op04 (Read Input Regs - 3x)
    ...
    "REG_UG2_EntradasAnalogicas_MRR_PressK1CaixaExpiral": 44903,  # Scale 0.1 - Op04 (Read Input Regs - 3x)
    "REG_UG2_EntradasAnalogicas_MRR_PressK1CaixaExpiral_MaisCasas": 44903, # Scale 0.01 - Op04 (Read Input Regs)
...
SA = {
    ...
    "REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_AB": 22789, #antigo -> 16  # Scale 0.1 - Op04 (Read Input Regs - 3x)
    "REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_BC": 22790, #antigo -> 17  # Scale 0.1 - Op04 (Read Input Regs - 3x)
    "REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_CA": 22791, #antigo -> 18  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
TDA = {
    ...
    "REG_TDA_EntradasAnalogicas_MRR_NivelDepoisGrade": 22767, # antgo -> 1  # Scale 0.01 - Op04 (Read Input Regs - 3x)
}