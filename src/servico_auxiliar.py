...
class ServicoAuxiliar:
    ...
    def carregar_leituras(cls) -> "None":
        ...
        cls.l_esgot_bomba_2_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["ESGOTAMENTO_BOMBA_2_FALHA"], descricao="[SA]  Falha Bomba de Esgotamento 2") # TODO -> verificar invertido
        ...
        cls.l_sfa_entra_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ENTRADA_ELEMENTO_1_ABERTA"], descricao="[SA]  Sistema de Filtragem A Entrada Elemento 1 Aberto") # TODO -> verificar invertido
        ...
        cls.l_sfb_limp_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_LIMPEZA_ELEMENTO_1_ABERTA"], descricao="[SA]  Sistema de Filtragem B Elemento 1 Aberto") # TODO -> verificar invertido
        ...
        cls.l_sfb_falha_abrir_entra_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEMENTO_1_FALHA_ABRIR_ENTRADA"], descricao="[SA]  Falha Abrir Entrada Elemento 1 do Sistema de Filtragem B") # TODO -> verificar invertido
