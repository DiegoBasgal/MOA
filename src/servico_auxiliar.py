...
class ServicoAuxiliar:
    ...
    def carregar_leituras(cls) -> "None":
        ...
        """
        cls.l_disj_gmg_fechado = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_GMG_FECHADO"], descricao="[SA]  Disjuntor Grupo Motor Gerador Fechado")
        ...
        cls.l_disj_tsa_trip = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_TSA_TRIP"], descricao="[SA]  Trip Disjuntor Serviço Auxiliar")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_disj_tsa_trip, CONDIC_INDISPONIBILIZAR))

        cls.l_poco_dren_nivel_muito_alto = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["PD_SENS_NV_MUITO_ALTO"], descricao="[SA]  Poço de Drenagem Nível Muito Alto")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_poco_dren_nivel_muito_alto, CONDIC_INDISPONIBILIZAR))

        cls.l_nv_jusante_muito_alto = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["NV_JUSANTE_MUITO_ALTO"], descricao="[SA]  Nível Jusante Muito Alto")
        ...
        cls.l_disj_gmg_falha_abrir = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_GMG_FALHA_ABRIR"], descricao="[SA]  Falha Abertura Disjuntor Grupo Motor Gerador")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_disj_gmg_falha_abrir, CONDIC_INDISPONIBILIZAR))

        cls.l_disj_tsa_falha_fechar = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_GMG_FALHA_FECHAR"], descricao="[SA]  Falha Fechamento Disjuntor Serviço Auxiliar")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_disj_tsa_falha_fechar, CONDIC_INDISPONIBILIZAR))

        cls.l_disj_tsa_falha_abrir = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_TSA_FALHA_ABRIR"], descricao="[SA]  Falha Abertura Disjuntor Serviço Auxiliar")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_disj_tsa_falha_abrir, CONDIC_INDISPONIBILIZAR))

        cls.l_bloq_50bf_atuado = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["BLOQ_50BF_ATUADO"], descricao="[SA]  Bloqueio 50BF Relé SA Atuado")
        cls.condicionadores.append(c.CondicionadorBase(cls.l_bloq_50bf_atuado, CONDIC_INDISPONIBILIZAR))

        cls.l_bloq_86btlsa_atuado = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["BLOQ_86BTLSA_ATUADO"], descricao="[SA]  Bloqueio 86BTLSA Relé SA Atuado")
        ...
        cls.l_disj_gmg_trip = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_GMG_TRIP"], descricao="[SA]  Trip Disjuntor Grupo Motor Gerador")
        cls.l_carreg_baterias_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["CB_FALHA"], descricao="[SA]  Falha Carregador de Baterias")
        cls.l_disj_gmg_falha_fechar = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJ_GMG_FALHA_FECHAR"], descricao="[SA]  Falha Fechamento Disjuntor Grupo Motor Gerador")
        cls.l_disjs_modo_remoto = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DJS_MODO_REMOTO"], descricao="[SA]  Disjuntores em Modo Remoto")
        ...
        cls.l_sup_tensao_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SUPER_TENSAO_FALHA"], descricao="[SA]  Falha Tensão pelo Supervisório")
        cls.l_sup_tensao_tsa_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SUPER_TENSAO_TSA_FALHA"], descricao="[SA]  Falha Tensão Serviço Auxiliar pelo Supervisório")
        cls.l_sup_tensao_gmg_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SUPER_TENSAO_GMG_FALHA"], descricao="[SA]  Falha Tensão Grupo Motor Gerador pelo Supervisório")

        cls.l_poco_dren_nv_alto = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["PD_SENS_NV_ALTO"], descricao="[SA]  Poço de Drenagem Nível Alto")
        cls.l_dren_boias_discrepancia = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DREN_BOIAS_DISCREPANCIA"], descricao="[SA]  Dicrepância Boias de Drenagem")
        cls.l_poco_dren_nv_muito_baixo = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["PD_SENS_NV_MUITO_BAIXO"], descricao="[SA]  Poço de Drenagem Nível Muito Alto")

        cls.l_dren_bomba_1_indisp = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DREN_BOMBA_1_INDISPONV"], descricao="[SA]  Bomba de Drenagem 1 Indisponível")
        cls.l_dren_bomba_2_indisp = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["DREN_BOMBA_1_INDISPONV"], descricao="[SA]  Bomba de Drenagem 2 Indisponível")
        ...
        cls.l_esgot_bomba_2_falha = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["ESGOTA_BOMBA_2_FALHA"], descricao="[SA]  Falha Bomba de Esgotamento 2") # TODO -> verificar invertido
        cls.l_esgot_bomba_1_indisp = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SF_BOMBA_1_INDISPONV"], descricao="[SA]  Bomba de Esgotamento 1 Indisponível")
        cls.l_esgot_bomba_2_indisp = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["ESGOTA_BOMBA_2_INDISPONV"], descricao="[SA]  Bomba de Esgotamento 2 Indisponível")
        cls.l_poco_dren_bomba_1_defeito = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["PD_BOMBA_1_DEFEITO"], descricao="[SA]  Defeito Bomba 1 Poço de Drenagem")
        cls.l_poco_dren_bomba_2_defeito = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["PD_BOMBA_2_DEFEITO"], descricao="[SA]  Defeito Bomba 2 Poço de Drenagem")

        cls.l_sfa_limp_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_LIMP_ELEM_1_ABERTA"], descricao="[SA]  Sistema de Filtragem A Elemento 1 Aberto")
        cls.l_sfa_limp_elem_2_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_LIMP_ELEM_2_ABERTA"], descricao="[SA]  Sistema de Filtragem A Elemento 2 Aberto")
        cls.l_sfa_entra_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ENTRA_ELEM_1_ABERTA"], descricao="[SA]  Sistema de Filtragem A Entrada Elemento 1 Aberto") # TODO -> verificar invertido
        cls.l_sfa_entra_elem_2_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ENTRA_ELEM_2_ABERTA"], descricao="[SA]  Sistema de Filtragem A Entrada Elemento 2 Aberto")
        cls.l_sfa_falha_abrir_limpeza_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_1_FALHA_ABRIR_LIMP"], descricao="[SA]  Falha Abrir Limpeza do Elemento 1 do Sistema de Filtragem A")
        cls.l_sfa_falha_fechar_limpeza_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_1_FALHA_FECHAR_LIMP"], descricao="[SA]  Falha Fechar limpeza do Elemento 1 do Sistema de Filtragem A")
        cls.l_sfa_falha_abrir_entra_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_1_FALHA_ABRIR_ENTRA"], descricao="[SA]  Falha Abrir Entrada Elemento 1 do Sistema de Filtragem A")
        cls.l_sfa_falha_fechar_entra_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_1_FALHA_FECHAR_ENTRA"], descricao="[SA]  Falha Fechar Entrada Elemento 1 do Sistema de Filtragem A")
        cls.l_sfa_falha_abrir_limpeza_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_2_FALHA_ABRIR_LIMP"], descricao="[SA]  Falha Abrir Limpeza do Elemento 2 do Sistema de Filtragem A")
        cls.l_sfa_falha_fechar_limpeza_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_2_FALHA_FECHAR_LIMP"], descricao="[SA]  Falha Fechar limpeza do Elemento 2 do Sistema de Filtragem A")
        cls.l_sfa_falha_abrir_entra_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_2_FALHA_ABRIR_ENTRA"], descricao="[SA]  Falha Abrir Entrada Elemento 2 do Sistema de Filtragem A")
        cls.l_sfa_falha_fechar_entra_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFA_ELEM_2_FALHA_FECHAR_ENTRA"], descricao="[SA]  Falha Fechar Entrada Elemento 2 do Sistema de Filtragem A")

        cls.l_sfb_limp_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_LIMP_ELEM_1_ABERTA"], descricao="[SA]  Sistema de Filtragem B Elemento 1 Aberto") # TODO -> verificar invertido
        cls.l_sfb_limp_elem_2_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_LIMP_ELEM_2_ABERTA"], descricao="[SA]  Sistema de Filtragem B Elemento 2 Aberto")
        cls.l_sfb_entra_elem_1_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ENTRA_ELEM_1_ABERTA"], descricao="[SA]  Sistema de Filtragem B Entrada Elemento 1 Aberto")
        cls.l_sfb_entra_elem_2_aberta = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ENTRA_ELEM_2_ABERTA"], descricao="[SA]  Sistema de Filtragem B Entrada Elemento 2 Aberto")
        cls.l_sfb_falha_abrir_limpeza_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_1_FALHA_ABRIR_LIMP"], descricao="[SA]  Falha Abrir Limpeza do Elemento 1 do Sistema de Filtragem B")
        cls.l_sfb_falha_fechar_limpeza_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_1_FALHA_FECHAR_LIMP"], descricao="[SA]  Falha Fechar limpeza do Elemento 1 do Sistema de Filtragem B")
        cls.l_sfb_falha_abrir_entra_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_1_FALHA_ABRIR_ENTRA"], descricao="[SA]  Falha Abrir Entrada Elemento 1 do Sistema de Filtragem B") # TODO -> verificar invertido
        cls.l_sfb_falha_fechar_entra_elem_1 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_1_FALHA_FECHAR_ENTRA"], descricao="[SA]  Falha Fechar Entrada Elemento 1 do Sistema de Filtragem B")
        cls.l_sfb_falha_abrir_limpeza_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_2_FALHA_ABRIR_LIMP"], descricao="[SA]  Falha Abrir Limpeza do Elemento 2 do Sistema de Filtragem B")
        cls.l_sfb_falha_fechar_limpeza_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_2_FALHA_FECHAR_LIMP"], descricao="[SA]  Falha Fechar limpeza do Elemento 2 do Sistema de Filtragem B")
        cls.l_sfb_falha_abrir_entra_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_2_FALHA_ABRIR_ENTRA"], descricao="[SA]  Falha Abrir Entrada Elemento 2 do Sistema de Filtragem B")
        cls.l_sfb_falha_fechar_entra_elem_2 = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["SFB_ELEM_2_FALHA_FECHAR_ENTRA"], descricao="[SA]  Falha Fechar Entrada Elemento 2 do Sistema de Filtragem B")

        cls.l_nv_jusante_alto = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["NV_JUSANTE_ALTO"], descricao="[SA]  Nível Jusante Alto")
        cls.l_nv_jusante_muito_baixo = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["NV_JUSANTE_MUITO_BAIXO"], descricao="[SA]  Nível Jusante Muito Baixo")
        cls.l_nv_jusante_falha_leitura = lei.LeituraModbusBit(serv.Servidores.clp["SA"], REG_SASE["NV_JUSANTE_FALHA_LEITURA"], descricao="[SA]  Falha Leitura Nível Jusante")
