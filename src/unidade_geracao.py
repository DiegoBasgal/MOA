...
class UnidadeGeracao:
    def __init__(self, id: int = None, cfg: dict = None, clp: "dict[str, ModbusClient]" = None, db: Database = None, con: ConectorCampo = None):
        ...
        # R
        self.leitura_temperatura_fase_R = LeituraModbus("Temperatura fase R", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_01"], op=4)
        ...
        # S
        self.leitura_temperatura_fase_S = LeituraModbus("Temperatura fase S", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_02"], op=4)
        ...
        # T
        self.leitura_temperatura_fase_T = LeituraModbus("Temperatura fase T", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_03"], op=4)
        ...
        # Nucleo estator
        self.leitura_temperatura_nucleo = LeituraModbus("Temperatura núcelo do estator", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_04"], op=4)
        ...
        # MRD 1
        self.leitura_temperatura_mrd1 = LeituraModbus("Temperatura mancal radial dianteiro", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_05"], op=4)
        ...
        # MRT 1
        self.leitura_temperatura_mrt1 = LeituraModbus("Temperatura mancal radial traseiro", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_06"], op=4)
        ...
        # MRD 2
        self.leitura_temperatura_mrd2 = LeituraModbus("Temperatura mancal radial dianteiro 2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_07"], op=4)
        ...
        # MRT 2
        self.leitura_temperatura_mrt2 = LeituraModbus("Temperatura mancal radial traseiro 2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_08"], op=4)
        ...
        # Saída de ar
        self.leitura_temperatura_saida_de_ar = LeituraModbus("Saída de ar", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RA_Temperatura_10"], op=4)
        ...
        # Mancal Guia Radial
        self.leitura_temperatura_guia_radial = LeituraModbus("Mancal Guia Radial", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_EA_TempMcGuiaRadial"])
        ...
        # Mancal Guia escora
        self.leitura_temperatura_guia_escora = LeituraModbus("Mancal Guia escora", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_EA_TempMcGuiaEscora"])
        ...
        self.leitura_temperatura_guia_contra_escora = LeituraModbus("Mancal Guia contra_escora", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_EA_TempMcGuiaContraEscora"])
        ...
        ## Comandos Digitais
        # GERAL
        self.leitura_CD_EmergenciaViaSuper = LeituraModbusCoil("CD_EmergenciaViaSuper", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_CD_EmergenciaViaSuper"])
        ...
        ## Retornos Digitais
        # TRIPS
        self.leitura_RD_TripEletrico = LeituraModbusCoil("RD_TripEletrico", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripEletrico"])
        ...
        self.leitura_RD_700G_Trip = LeituraModbusCoil("RD_700G_Trip", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_700G_Trip"])
        ...
        self.leitura_RD_TripMecanico = LeituraModbusCoil("RD_TripMecanico", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripMecanico"])
        ...
        ## Entradas Digitais
        # TRIPS
        self.leitura_ED_RV_Trip = LeituraModbusCoil("ED_RV_Trip", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_RV_Trip"])
        ...
        self.leitura_ED_AVR_Trip = LeituraModbusCoil("ED_AVR_Trip", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_AVR_Trip"])
        ...
        # RELÉS
        self.leitura_ED_SEL700G_Atuado = LeituraModbusCoil("ED_SEL700G_Atuado", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_SEL700G_Atuado"])
        ...
        self.leitura_ED_ReleBloqA86MAtuado = LeituraModbusCoil("ED_ReleBloqA86MAtuado", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_ReleBloqA86MAtuado"])
        ...
        self.leitura_ED_ReleBloqA86HAtuado = LeituraModbusCoil("ED_ReleBloqA86HAtuado", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_ReleBloqA86HAtuado"])
        ...
        # TRIPS
        self.leitura_ED_UHRV_TripBomba1 = LeituraModbusCoil("ED_UHRV_TripBomba1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHRV_TripBomba1"])
        ...
        self.leitura_ED_UHRV_TripBomba2 = LeituraModbusCoil("ED_UHRV_TripBomba2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHRV_TripBomba2"])
        ...
        self.leitura_ED_UHLM_TripBomba1 = LeituraModbusCoil("ED_UHLM_TripBomba1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_TripBomba1"])
        ...
        self.leitura_ED_UHLM_TripBomba2 = LeituraModbusCoil("ED_UHLM_TripBomba2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_TripBomba2"])
        ...
        self.leitura_ED_QCAUG_TripDisj52A1 = LeituraModbusCoil("ED_QCAUG_TripDisj52A1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_QCAUG_TripDisj52A1"])
        ...
        self.leitura_ED_TripAlimPainelFreio = LeituraModbusCoil("ED_TripAlimPainelFreio", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_TripAlimPainelFreio"])
        ...
        self.leitura_ED_QCAUG_TripDisjAgrup = LeituraModbusCoil("ED_QCAUG_TripDisjAgrup", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_QCAUG_TripDisjAgrup"])
        ...
        # FALHAS
        self.leitura_ED_AVR_FalhaInterna = LeituraModbusCoil("ED_AVR_FalhaInterna", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_AVR_FalhaInterna"])
        ...
        self.leitura_ED_SEL700G_FalhaInterna = LeituraModbusCoil("ED_SEL700G_FalhaInterna", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_SEL700G_FalhaInterna"])
        ...
        self.leitura_ED_QCAUG_Falha380VcaPainel = LeituraModbusCoil("ED_QCAUG_Falha380VcaPainel", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_QCAUG_Falha380VcaPainel"])
        ...
        # FALTAS
        self.leitura_ED_Falta125Vcc = LeituraModbusCoil("ED_Falta125Vcc", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_Falta125Vcc"])
        ...
        self.leitura_ED_Falta125VccCom = LeituraModbusCoil("ED_Falta125VccCom", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_Falta125VccCom"])
        ...
        self.leitura_ED_FaltaFluxoOleoMc = LeituraModbusCoil("ED_FaltaFluxoOleoMc", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FaltaFluxoOleoMc"])
        ...
        self.leitura_ED_Falta125VccAlimVal = LeituraModbusCoil("ED_Falta125VccAlimVal", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_Falta125VccAlimVal"])
        ...
        self.leitura_ED_UHLM_FaltaFluxTroc = LeituraModbusCoil("ED_UHLM_FaltaFluxTroc", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_FaltaFluxTroc"])
        ...
        self.leitura_ED_UHLM_FaltaPressTroc = LeituraModbusCoil("ED_UHLM_FaltaPressTroc", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_FaltaPressTroc"]) # TODO retornar para DEVE_INDISPONIBILZIAR
        ...
        # Controle UHRV
        self.leitura_ED_UHRV_NivOleominimoPos36 = LeituraModbusCoil("ED_UHRV_NivOleominimoPos36", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHRV_NivOleominimoPos36"])
        ...
        self.leitura_ED_UHRV_NivOleoCriticoPos35 = LeituraModbusCoil("ED_UHRV_NivOleoCriticoPos35", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHRV_NivOleoCriticoPos35"])
        ...
        # Controle UHLM
        self.leitura_ED_UHLM_FluxoMcTras = LeituraModbusCoil("ED_UHLM_FluxoMcTras", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_FluxoMcTras"])
        ...
        self.leitura_ED_UHLM_NivelminOleo = LeituraModbusCoil("ED_UHLM_NivelminOleo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_NivelminOleo"])
        ...
        self.leitura_ED_UHLM_NivelCritOleo = LeituraModbusCoil("ED_UHLM_NivelCritOleo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_NivelCritOleo"])
        ...
        self.leitura_ED_UHLM_FluxoMcDianteiro = LeituraModbusCoil("ED_UHLM_FluxoMcDianteiro", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_FluxoMcDianteiro"])
        ...
        self.leitura_ED_UHLM_Filt1PresSujo100Sujo = LeituraModbusCoil("ED_UHLM_Filt1PresSujo100Sujo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_Filt1PresSujo100Sujo"])
        ...
        self.leitura_ED_UHLM_Filt2PresSujo100Sujo = LeituraModbusCoil("ED_UHLM_Filt2PresSujo100Sujo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_UHLM_Filt2PresSujo100Sujo"])
        ...
        # Controle Freios
        self.leitura_ED_FreioSemEnergia = LeituraModbusCoil("ED_FreioSemEnergia", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FreioSemEnergia"])
        ...
        self.leitura_ED_FreioFiltroSaturado = LeituraModbusCoil("ED_FreioFiltroSaturado", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FreioFiltroSaturado"])
        ...
        # Controle Filtros
        self.leitura_ED_FiltroRetSujo100Sujo = LeituraModbusCoil("ED_FiltroRetSujo100Sujo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FiltroRetSujo100Sujo"])
        ...
        self.leitura_ED_FiltroPresSujo100Sujo = LeituraModbusCoil("ED_FiltroPresSujo100Sujo", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FiltroPresSujo100Sujo"])
        ...
        self.leitura_ED_FiltroPressaoBbaMecSj100 = LeituraModbusCoil("ED_FiltroPressaoBbaMecSj100", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_FiltroPressaoBbaMecSj100"])
        ...
        # Outros
        self.leitura_ED_PalhetasDesal = LeituraModbusCoil("ED_PalhetasDesal", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_PalhetasDesal"])
        ...
        self.leitura_ED_ValvBorbTravada = LeituraModbusCoil("ED_ValvBorbTravada", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_ValvBorbTravada"],)
        ...
        self.leitura_ED_SobreVeloMecPos18 = LeituraModbusCoil("ED_SobreVeloMecPos18", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_SobreVeloMecPos18"])
        ...
        self.leitura_ED_NivelMAltoPocoDren = LeituraModbusCoil("ED_NivelMAltoPocoDren", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_ED_NivelMAltoPocoDren"])
        ...
        ## Retornos Digitais
        # TRIPS
        self.leitura_RD_TripVibr1 = LeituraModbusCoil("RD_TripVibr1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripVibr1"])
        ...
        self.leitura_RD_TripVibr2 = LeituraModbusCoil("RD_TripVibr2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripVibr2"])
        ...
        self.leitura_RD_TripTempUHRV = LeituraModbusCoil("RD_TripTempUHRV", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempUHRV"])
        ...
        self.leitura_RD_TripTempUHLM = LeituraModbusCoil("RD_TripTempUHLM", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempUHLM"])
        ...
        self.leitura_RD_TripTempGaxeteiro = LeituraModbusCoil("RD_TripTempGaxeteiro", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempGaxeteiro"])
        ...
        self.leitura_RD_TripTempMcGuiaRadial = LeituraModbusCoil("RD_TripTempMcGuiaRadial", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempMcGuiaRadial"])
        ...
        self.leitura_RD_TripTempMcGuiaEscora = LeituraModbusCoil("RD_TripTempMcGuiaEscora", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempMcGuiaEscora"])
        ...
        self.leitura_RD_TripTempMcGuiaContraEscora = LeituraModbusCoil("RD_TripTempMcGuiaContraEscora", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_TripTempMcGuiaContraEscora"])
        ...
        self.leitura_RD_CLP_Falha = LeituraModbusCoil("RD_CLP_Falha", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_CLP_Falha"])
        ...
        self.leitura_RD_Q_Negativa = LeituraModbusCoil("RD_Q_Negativa", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_Q_Negativa"])
        ...
        self.leitura_RD_Remota_Falha = LeituraModbusCoil("RD_Remota_Falha", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_Remota_Falha"])
        ...
        self.leitura_RD_FalhaIbntDisjGer = LeituraModbusCoil("RD_FalhaIbntDisjGer", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_FalhaIbntDisjGer"])
        ...
        self.leitura_RD_UHRV_FalhaAcionBbaM1 = LeituraModbusCoil("RD_UHRV_FalhaAcionBbaM1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_UHRV_FalhaAcionBbaM1"])
        ...
        self.leitura_RD_UHRV_FalhaAcionBbaM2 = LeituraModbusCoil("RD_UHRV_FalhaAcionBbaM2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_UHRV_FalhaAcionBbaM2"])
        ...
        self.leitura_RD_UHLM_FalhaAcionBbaM1 = LeituraModbusCoil("RD_UHLM_FalhaAcionBbaM1", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_UHLM_FalhaAcionBbaM1"])
        ...
        self.leitura_RD_UHLM_FalhaAcionBbaM2 = LeituraModbusCoil("RD_UHLM_FalhaAcionBbaM2", self.clp[f"UG{self.id}"], REG[f"UG{self.id}_RD_UHLM_FalhaAcionBbaM2"])
    ...
    def partir(self) -> bool:
        try:
            if not self.clp[f"UG{self.id}"].read_discrete_inputs(REG[f"UG{self.id}_COND_PART"], 1)[0]:
    ...
    def enviar_setpoint(self, setpoint_kw: int) -> bool:
        try:
            ...
            if self.setpoint > 1:
                ...
                response = self.clp[f"UG{self.id}"].write_single_register(REG[f"UG{self.id}_SA_SPPotAtiva"], self.setpoint)
            return response
