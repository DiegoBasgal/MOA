REG_UG1_RV_MaquinaParada = 0   # Op02 (Read Input Status)
REG_UG1_RV_VeloMenor30 = 1   # Op02 (Read Input Status)
REG_UG1_RV_VeloMaior90 = 2   # Op02 (Read Input Status)
REG_UG1_RV_Trip = 3   # Op02 (Read Input Status)
REG_UG1_AVR_Trip = 4   # Op02 (Read Input Status)
REG_UG1_AVR_FalhaInterna = 5   # Op02 (Read Input Status)
REG_UG1_AVR_Ligado = 6   # Op02 (Read Input Status)
REG_UG1_PotenciaNula = 7   # Op02 (Read Input Status)
REG_UG1_Falta125Vcc = 8   # Op02 (Read Input Status)
REG_UG1_DisjGeradorInserido = 9   # Op02 (Read Input Status)
REG_UG1_DisjGeradorAberto = 10   # Op02 (Read Input Status)
REG_UG1_DisjGeradorFechado = 11   # Op02 (Read Input Status)
REG_UG1_EmergPainelAtuada = 12   # Op02 (Read Input Status)
REG_UG1_Falta125VccCom = 13   # Op02 (Read Input Status)
REG_UG1_Falta125VccAlimVal = 14   # Op02 (Read Input Status)
REG_UG1_FalhaDisjTpsProt = 15   # Op02 (Read Input Status)
REG_UG1_ReleBloqA86HAtuado = 16   # Op02 (Read Input Status)
REG_UG1_ReleBloqA86MAtuado = 17   # Op02 (Read Input Status)
REG_UG1_SEL700G_Atuado = 18   # Op02 (Read Input Status)
REG_UG1_SEL700G_FalhaInterna = 19   # Op02 (Read Input Status)
REG_UG1_FAlta125VccQPCUG2 = 20   # Op02 (Read Input Status)
REG_UG1_FAlta125VccQPCUG3 = 21   # Op02 (Read Input Status)
REG_UG1_NivelMAltoPocoDren = 22   # Op02 (Read Input Status)
REG_UG1_DijAlimAVRLig = 23   # Op02 (Read Input Status)
REG_UG1_FreioPastilhaGasta = 24   # Op02 (Read Input Status)
REG_UG1_FreioPressNormal = 25   # Op02 (Read Input Status)
REG_UG1_FreioDesaplicado = 26   # Op02 (Read Input Status)
REG_UG1_FreioAplicado = 27   # Op02 (Read Input Status)
REG_UG1_Reserva254 = 28   # Op02 (Read Input Status)
REG_UG1_FreioCmdRemoto = 29   # Op02 (Read Input Status)
REG_UG1_FreioFiltroSaturado = 30   # Op02 (Read Input Status)
REG_UG1_FreioSemEnergia = 31   # Op02 (Read Input Status)
REG_UG1_UHRV_PressCriticaPos321 = 32   # Op02 (Read Input Status)
REG_UG1_UHRV_PressMinimaPos322 = 33   # Op02 (Read Input Status)
REG_UG1_UHRV_PressNominalPos323 = 34   # Op02 (Read Input Status)
REG_UG1_UHRV_Reserva263 = 35   # Op02 (Read Input Status)
REG_UG1_UHRV_Reserva264 = 36   # Op02 (Read Input Status)
REG_UG1_FiltroPresSujo75Troc = 37   # Op02 (Read Input Status)
REG_UG1_FiltroPresSujo100Sujo = 38   # Op02 (Read Input Status)
REG_UG1_FiltroRetSujo75Troc = 39   # Op02 (Read Input Status)
REG_UG1_FiltroRetSujo100Sujo = 40   # Op02 (Read Input Status)
REG_UG1_UHRV_NivOleoCriticoPos35 = 41   # Op02 (Read Input Status)
REG_UG1_UHRV_NivOleominimoPos36 = 42   # Op02 (Read Input Status)
REG_UG1_UHRV_PressaoEqual = 43   # Op02 (Read Input Status)
REG_UG1_ValvBorbTravada = 44   # Op02 (Read Input Status)
REG_UG1_ValvBorbDestravada = 45   # Op02 (Read Input Status)
REG_UG1_ValvBorbFechada = 46   # Op02 (Read Input Status)
REG_UG1_ValvBorbAberta = 47   # Op02 (Read Input Status)
REG_UG1_ValvBorbADeriva = 48   # Op02 (Read Input Status)
REG_UG1_ValvByPassFechada = 49   # Op02 (Read Input Status)
REG_UG1_ValvByPassAberta = 50   # Op02 (Read Input Status)
REG_UG1_DistribuidorFechado = 51   # Op02 (Read Input Status)
REG_UG1_FluxInjAguaPos14 = 52   # Op02 (Read Input Status)
REG_UG1_PresInjAguaPos15 = 53   # Op02 (Read Input Status)
REG_UG1_SobreVeloMecPos18 = 54   # Op02 (Read Input Status)
REG_UG1_FaltaFluxoOleoMc = 55   # Op02 (Read Input Status)
REG_UG1_PalhetasDesal = 56   # Op02 (Read Input Status)
REG_UG1_UHLM_FaltaFluxTroc = 57   # Op02 (Read Input Status)
REG_UG1_UHLM_FaltaPressTroc = 58   # Op02 (Read Input Status)
REG_UG1_UHLMFilt1PresSujo75Troc = 59   # Op02 (Read Input Status)
REG_UG1_UHLMFilt1PresSujo100Sujo = 60   # Op02 (Read Input Status)
REG_UG1_UHLMFilt2PresSujo75Troc = 61   # Op02 (Read Input Status)
REG_UG1_UHLMFilt2PresSujo100Sujo = 62   # Op02 (Read Input Status)
REG_UG1_UHLM_NivelCritOleo = 63   # Op02 (Read Input Status)
REG_UG1_UHLM_NivelminOleo = 64   # Op02 (Read Input Status)
REG_UG1_FiltroPressaoBbaMecSj75 = 65   # Op02 (Read Input Status)
REG_UG1_FiltroPressaoBbaMecSj100 = 66   # Op02 (Read Input Status)
REG_UG1_FaltaFluxoBbaMec = 67   # Op02 (Read Input Status)
REG_UG1_UHLM_FluxoMcDianteiro = 68   # Op02 (Read Input Status)
REG_UG1_UHLM_FluxoMcTras = 69   # Op02 (Read Input Status)
REG_UG1_UHLM_PressPos37 = 70   # Op02 (Read Input Status)
REG_UG1_Reserva307 = 71   # Op02 (Read Input Status)
REG_UG1_UHLM_Bomba1Ligada = 72   # Op02 (Read Input Status)
REG_UG1_UHLM_Bomba2Ligada = 73   # Op02 (Read Input Status)
REG_UG1_CompressorLigado = 74   # Op02 (Read Input Status)
REG_UG1_UHRV_Bomba1Ligada = 75   # Op02 (Read Input Status)
REG_UG1_UHRV_Bomba2Ligada = 76   # Op02 (Read Input Status)
REG_UG1_QCAUG_Falha380VcaPainel = 77   # Op02 (Read Input Status)
REG_UG1_QCAUG_Disj52A1Lig = 78   # Op02 (Read Input Status)
REG_UG1_QCAUG_TripDisj52A1 = 79   # Op02 (Read Input Status)
REG_UG1_UHLM_TripBomba1 = 80   # Op02 (Read Input Status)
REG_UG1_UHLM_TripBomba2 = 81   # Op02 (Read Input Status)
REG_UG1_TripPartRes = 82   # Op02 (Read Input Status)
REG_UG1_UHRV_TripBomba1 = 83   # Op02 (Read Input Status)
REG_UG1_UHRV_TripBomba2 = 84   # Op02 (Read Input Status)
REG_UG1_TripAlimPainelFreio = 85   # Op02 (Read Input Status)
REG_UG1_PainelFreioStatus = 86   # Op02 (Read Input Status)
REG_UG1_QCAUG_TripDisjAgrup = 87   # Op02 (Read Input Status)
REG_UG1_QCAUG1_Remoto = 88   # Op02 (Read Input Status)
...
REG_UG1_RetornosDigitais_MXR_TripTempMcGuiaContraEscora = 167   # Op02 (Read Input Status)
...
REG_UG1_RetornosAnalogicos_MWR_PM_710_Potencia_Aparente = 44   # Op04 (Read Input Regs - 3x)
REG_UG1_RetornosAnalogicos_MWR_PM_710_Potencia_Ativa = 45   # Op04 (Read Input Regs - 3x)
REG_UG1_RetornosAnalogicos_MWR_PM_710_Potencia_Reativa = 46   # Op04 (Read Input Regs - 3x)
...
REG_UG1_EntradasAnalogicas_MRR_PosicaoDistribuidor = 0   # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG1_EntradasAnalogicas_MRR_PressAguaVedEixo = 4   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_PressDifCaixaExpiral = 5   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_PressK1CaixaExpiral = 6   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_PressK1Succao = 7   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_TempGaxetas = 8   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_TempMcGuiaRadial = 9   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_TempMcGuiaEscora = 10   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_TempMcGuiaContraEscora = 11   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_VibMcGuiaRadial = 12   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_VibMcGuiaAxial = 13   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_UHRV_TempOleo = 14   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_UHRV_Pressao = 15   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_UHLM_TempOleo = 16   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_PressaoArComp = 17   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_VazEntrOleoMcDiant = 18   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_EntradasAnalogicas_MRR_VazEntrOleoMcTras = 19   # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG1_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Consumida = 149   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Consumida = 151   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Fornecida = 153   # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG1_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Fornecida = 155   # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG2_EntradasDigitais_MXI_UHLMFilt1PresSujo75Troc = 59  # Op02 (Read Input Status)
REG_UG2_EntradasDigitais_MXI_UHLMFilt1PresSujo100Sujo = 60  # Op02 (Read Input Status)
REG_UG2_EntradasDigitais_MXI_UHLMFilt2PresSujo75Troc = 61  # Op02 (Read Input Status)
REG_UG2_EntradasDigitais_MXI_UHLMFilt2PresSujo100Sujo = 62  # Op02 (Read Input Status)
...
REG_UG2_RetornosDigitais_MXR_TripTempMcGuiaContraEscora = 167  # Op02 (Read Input Status)
...
REG_UG2_RetornosAnalogicos_MWR_PM_710_Potencia_Aparente = 44  # Op04 (Read Input Regs - 3x)
REG_UG2_RetornosAnalogicos_MWR_PM_710_Potencia_Ativa = 45  # Op04 (Read Input Regs - 3x)
REG_UG2_RetornosAnalogicos_MWR_PM_710_Potencia_Reativa = 46  # Op04 (Read Input Regs - 3x)
...
REG_UG2_EntradasAnalogicas_MRR_PosicaoDistribuidor = 0  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG2_EntradasAnalogicas_MRR_PressAguaVedEixo = 4  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_PressDifCaixaExpiral = 5  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_PressK1CaixaExpiral = 6  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_PressK1Succao = 7  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_TempGaxetas = 8  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaRadial = 9  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaEscora = 10  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaContraEscora = 11  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_VibMcGuiaRadial = 12  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_VibMcGuiaAxial = 13  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_UHRV_TempOleo = 14  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_UHRV_Pressao = 15  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_UHLM_TempOleo = 16  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_Reserva03 = 17  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_VazEntrOleoMcDiant = 18  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_EntradasAnalogicas_MRR_VazEntrOleoMcTras = 19  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG2_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Consumida = 149  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Consumida = 151  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Fornecida = 153  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG2_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Fornecida = 155  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG3_EntradasDigitais_MXI_RV_Trip = 3  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_AVR_Trip = 4  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_AVR_FalhaInterna = 5  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_AVR_Ligado = 6  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_PotenciaNula = 7  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_Falta125Vcc = 8  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_DisjGeradorInserido = 9  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_DisjGeradorAberto = 10  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_DisjGeradorFechado = 11  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_EmergPainelAtuada = 12  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_Falta125VccCom = 13  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_Falta125VccAlimVal = 14  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FalhaDisjTpsProt = 15  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ReleBloqA86HAtuado = 16  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ReleBloqA86MAtuado = 17  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_SEL700G_Atuado = 18  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_SEL700G_FalhaInterna = 19  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FAlta125VccQPCUG2 = 20  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FAlta125VccQPCUG3 = 21  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_NivelMAltoPocoDren = 22  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_DijAlimAVRLig = 23  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioPastilhaGasta = 24  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioPressNormal = 25  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioDesaplicado = 26  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioAplicado = 27  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_Reserva254 = 28  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioCmdRemoto = 29  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioFiltroSaturado = 30  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FreioSemEnergia = 31  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_PressCriticaPos321 = 32  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_PressMinimaPos322 = 33  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_PressNominalPos323 = 34  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_Reserva263 = 35  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_Reserva264 = 36  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroPresSujo75Troc = 37  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroPresSujo100Sujo = 38  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroRetSujo75Troc = 39  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroRetSujo100Sujo = 40  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_NivOleoCriticoPos35 = 41  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_NivOleominimoPos36 = 42  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_PressaoEqual = 43  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvBorbTravada = 44  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvBorbDestravada = 45  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvBorbFechada = 46  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvBorbAberta = 47  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvBorbADeriva = 48  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvByPassFechada = 49  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_ValvByPassAberta = 50  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_DistribuidorFechado = 51  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FluxInjAguaPos14 = 52  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_PresInjAguaPos15 = 53  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_SobreVeloMecPos18 = 54  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FaltaFluxoOleoMc = 55  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_PalhetasDesal = 56  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_FaltaFluxTroc = 57  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_FaltaPressTroc = 58  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLMFilt1PresSujo75Troc = 59  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLMFilt1PresSujo100Sujo = 60  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLMFilt2PresSujo75Troc = 61  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLMFilt2PresSujo100Sujo = 62  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_NivelCritOleo = 63  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_NivelminOleo = 64  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroPressaoBbaMecSj75 = 65  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FiltroPressaoBbaMecSj100 = 66  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_FaltaFluxoBbaMec = 67  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_FluxoMcDianteiro = 68  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_FluxoMcTras = 69  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_PressPos37 = 70  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_Reserva307 = 71  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_Bomba1Ligada = 72  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHLM_Bomba2Ligada = 73  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_PartResLigada = 74  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_Bomba1Ligada = 75  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_UHRV_Bomba2Ligada = 76  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_QCAUG_Falha380VcaPainel = 77  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_QCAUG_Disj52A1Lig = 78  # Op02 (Read Input Status)
...
REG_UG3_EntradasDigitais_MXI_PainelFreioStatus = 86  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_QCAUG_TripDisjAgrup = 87  # Op02 (Read Input Status)
REG_UG3_EntradasDigitais_MXI_QCAUG3_Remoto = 88  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TensaoEstabilizada = 128  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_EmergenciaViaSuper = 129  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_SeqManual = 130  # Op02 (Read Input Status)
...
REG_UG3_RetornosDigitais_MXR_FalhaAcionAbertValvByPass = 139  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_FalhaAcionFechaValvByPass = 140  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_CondOK_M1 = 141  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_CondOK_M2 = 142  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_CondOK_M1 = 143  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_CondOK_M2 = 144  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Bombas_UHRV_Ligada = 145  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM1 = 146  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM2 = 147  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM1 = 148  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM2 = 149  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_PressaoOK = 150  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHRV_BbaM1Princ = 151  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_BbaM1Princ = 152  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Filtros_Manual = 153  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_FalhaAcionRT = 154  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_RV_CondOK = 155  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_RT_CondOK = 156  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_AVR_HabRefExterna = 157  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_AVR_ControleFP = 158  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UHLM_Ligada = 159  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Filtro1Sel = 160  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Filtro2Sel = 161  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_QCAUGFalhaAcionPartRes = 162  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_FalhaAcionFreio = 163  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempGaxeteiro = 164  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempMcGuiaRadial = 165  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempMcGuiaEscora = 166  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempMcGuiaContraEscora = 167  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempUHRV = 168  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripTempUHLM = 169  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripVibr1 = 170  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripVibr2 = 171  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_FalhaIbntDisjGer = 172  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_AbortaPartida = 173  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TempoPartidaExc = 174  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_ValvInjArRotorLig = 175  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_ValvInjArRotorAuto = 176  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PreCondPartidaOK = 177  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaValvSeg = 178  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDeslValvSeg = 179  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoAbreValvBorb = 180  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoFechaValvBorb = 181  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaUHRV = 182  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDesligaUHRV = 183  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaRT = 184  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDesligaRT = 185  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaRV = 186  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDesligaRV = 187  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoAbreValvByPass = 188  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoFechaValvByPass = 189  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaUHLM = 190  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDesligaUHLM = 191  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoAbreDisjuntor = 192  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaFreioPara = 193  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoDeslFreioPart = 194  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoSincroniza = 195  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_EN = 196  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_Trip = 197  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_01 = 198  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_02 = 199  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_03 = 200  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_04 = 201  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_05 = 202  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_700G_TLED_06 = 203  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_SincronismoHab = 204  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_CLP_Falha = 205  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Remota_Falha = 206  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_PassoLigaFreioPart = 207  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_RV_RetiraCarga = 208  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_RV_RefRemHabilitada = 209  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_FalhaComunG3TDA = 210  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Q_Negativa = 211  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_UG3_StsBloqueio = 212  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_TripPressaoCaixaEspiral = 213  # Op02 (Read Input Status)
REG_UG3_RetornosDigitais_MXR_Trip_PBCE_Habilitado = 214  # Op02 (Read Input Status)
REG_UG3_ComandosDigitais_MXW_ResetGeral = 0  # Op15 (Write multiple coils)
...
REG_UG3_ComandosDigitais_MXW_DiminuiTensaoRT = 8  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_HabControleFP = 9  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DesabControleFP = 10  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_HabRefExterna = 11  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DesHabRefExterna = 12  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_AumentaFreq = 13  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DiminuiFreq = 14  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_HabFiltro1 = 15  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DesabFiltro1 = 16  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_HabFiltro2 = 17  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DesabFiltro2 = 18  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_Filtros_Manual = 19  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_Filtros_Auto = 20  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RV_Liga = 21  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RV_Desliga = 22  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RT_Liga = 23  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RT_Desliga = 24  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_AbreValvBorb = 25  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_FechaValvBorb = 26  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_AbreValvByPass = 27  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_FechaValvByPass = 28  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_LigaBbaM1 = 29  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_DesligaBbaM1 = 30  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_LigaBbaM2 = 31  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_DesligaBbaM2 = 32  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_SelM1Princ = 33  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHRV_SelM2Princ = 34  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_LigaBbaM1 = 35  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_DesligaBbaM1 = 36  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_LigaBbaM2 = 37  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_DesligaBbaM2 = 38  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_SelM1Princ = 39  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_UHLM_SelM2Princ = 40  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_HabSeqAuto = 41  # Op15 (Write multiple coils)
...
REG_UG3_ComandosDigitais_MXW_DeslDisj52G = 50  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_QCAUG_LigaPartRes = 51  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_QCAUG_DeslPartRes = 52  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_AbreDisj = 53  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_SelValvInjRotorAuto = 54  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_SelValvInjRotorManu = 55  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_LigaValvInjArRotor = 56  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_DeslValvInjArRotor = 57  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_Sincroniza = 58  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_AbortaSincronismo = 59  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_Reset_Hori_Gerador = 60  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_Cala_Sirene = 61  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RV_RetiraCarga = 62  # Op15 (Write multiple coils)
REG_UG3_ComandosDigitais_MXW_RV_RefRemHabilita = 63  # Op15 (Write multiple coils)
...
REG_UG3_RetornosAnalogicos_MWR_PM_710_Tensao_AB = 36  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Tensao_BC = 37  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Tensao_CA = 38  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Corrente_A = 39  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Corrente_B = 40  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Corrente_C = 41  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Frequencia = 42  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Fator_Potencia = 43  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Potencia_Aparente = 44  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Potencia_Ativa = 45  # Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_MWR_PM_710_Potencia_Reativa = 46  # Op04 (Read Input Regs - 3x)
...
REG_UG3_EntradasAnalogicas_MRR_PosicaoDistribuidor = 0  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Velocidade = 1  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Reserva01 = 2  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Reserva02 = 3  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_PressAguaVedEixo = 4  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_PressDifCaixaExpiral = 5  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_PressK1CaixaExpiral = 6  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_PressK1Succao = 7  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_TempGaxetas = 8  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_TempMcGuiaRadial = 9  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_TempMcGuiaEscora = 10  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_TempMcGuiaContraEscora = 11  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_VibMcGuiaRadial = 12  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_VibMcGuiaAxial = 13  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_UHRV_TempOleo = 14  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_UHRV_Pressao = 15  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_UHLM_TempOleo = 16  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Reserva03 = 17  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_VazEntrOleoMcDiant = 18  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_VazEntrOleoMcTras = 19  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Reserva04 = 20  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_EntradasAnalogicas_MRR_Reserva05 = 21  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_UG3_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Consumida = 149  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Consumida = 151  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_Float_MWR_PM_710_Energia_Reativa_Fornecida = 153  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_UG3_RetornosAnalogicos_Float_MWR_PM_710_Energia_Ativa_Fornecida = 155  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_Reserva07 = 15  # Scale - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_QCAP_TensaoT = 14  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_QCAP_TensaoS = 13  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_QCAP_TensaoR = 12  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_CBU01_TensaoBarra = 11  # Scale - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_CBU01_CorrenteBarra = 10  # Scale - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_QCCP_Tensao = 9  # Scale - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_QCCP_Corrente = 8  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_SA_EntradasAnalogicas_MRR_SA_NivelSuccao = 3  # Scale 0.01 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_HoraLigaGerador = 2  # Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_TE_TempEnrolamento = 1  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_EntradasAnalogicas_MRR_SA_TE_TempOleo = 0  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_BloqPressBaixa = 18  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_Local = 19  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_MolaDescarregada = 20  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_Super125VccCiCom = 21  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_Super125VccCiMot = 22  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_SuperBobFecham = 23  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_SuperBobAbert1 = 24  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_SuperBobAbert2 = 25  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_Sup125VccBoFeAb1 = 26  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_DisjDJ1_Sup125VccBoFeAb2 = 27  # Op02 (Read Discrete Inputs)
...
REG_SA_EntradasDigitais_MXI_SA_TE_AlarmeAlivioPressao = 39  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_TE_AlarmeTempOleo = 40  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_TE_AlarmeTempEnrolamento = 41  # Op02 (Read Discrete Inputs)
...
REG_SA_EntradasDigitais_MXI_SA_CSA1_FaltaTensao125Vcc = 67  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCADE_BombasDng_Desliga = 68  # Op02 (Read Discrete Inputs)
...
REG_SA_EntradasDigitais_MXI_SA_QCADE_BombaDng1_Ligada = 79  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCADE_BombaDng2_Ligada = 80  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCADE_BombaDng3_Ligada = 81  # Op02 (Read Discrete Inputs)
...
REG_SA_EntradasDigitais_MXI_SA_MSS_FalhaConvCACCRedeCA = 95  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_MSS_FalhaConvCACCSaidaCA = 96  # Op02 (Read Discrete Inputs)
...
REG_SA_EntradasDigitais_MXI_SA_QCAP_TensaoPresenteGE = 103  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCAP_TensaoPresenteTSA = 104  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCAP_Automatico = 105  # Op02 (Read Discrete Inputs)
REG_SA_EntradasDigitais_MXI_SA_QCAP_SubtensaoBarraGeral = 106  # Op02 (Read Discrete Inputs)
...
REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_AB = 16  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_BC = 17  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Tensao_CA = 18  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Corrente_A = 19  # Scale 0.01 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Corrente_B = 20  # Scale 0.01 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Corrente_C = 21  # Scale 0.01 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Frequencia = 22  # Scale 0.001 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Fator_Potencia = 23  # Scale 0.001 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Potencia_Aparente = 24  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Potencia_Reativa = 25  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM_810_Potencia_Ativa = 26  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Tensao_AB = 27  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Tensao_BC = 28  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Tensao_CA = 29  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Corrente_A = 30  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Corrente_B = 31  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Corrente_C = 32  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Frequencia = 33  # Scale 0.001 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Fator_Potencia = 34  # Scale 0.001 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Potencia_Aparente = 35  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Potencia_Reativa = 36  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM1_710_Potencia_Ativa = 37  # Scale 0.1 - Op04 (Read Input Regs - 3x)
...
REG_SA_RetornosAnalogicos_MWR_PM2_710_Tensao_AB = 41  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Tensao_BC = 42  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Tensao_CA = 43  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Corrente_A = 44  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Corrente_B = 45  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Corrente_C = 46  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Frequencia = 47  # Scale 0.001 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Fator_Potencia = 48  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Potencia_Aparente = 49  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_PM2_710_Potencia_Reativa = 50  # Op04 (Read Input Regs - 3x)
...
REG_SA_RetornosAnalogicos_MWR_CorrenteBaixa1 = 55  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteBaixa2 = 56  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteBaixa3 = 57  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteAlta1 = 58  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteAlta2 = 59  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteAlta3 = 60  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_CorrenteNeutro = 61  # Scale 0.1 - Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets = 62  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit00 = 63  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit01 = 64  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit02 = 65  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit03 = 66  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit04 = 67  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit05 = 68  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit06 = 69  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_MWR_SEL787_Targets_Links_Bit07 = 70  # Op04 (Read Input Regs - 3x)
...
REG_SA_RetornosAnalogicos_Float_MWR_PM_810_Energia_Reativa_Consumida = 149  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM_810_Energia_Ativa_Consumida = 151  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM_810_Energia_Reativa_Fornecida = 153  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM_810_Energia_Ativa_Fornecida = 155  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM1_710_Energia_Reativa_Consumida = 157  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM1_710_Energia_Ativa_Consumida = 159  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM1_710_Energia_Reativa_Fornecida = 161  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM1_710_Energia_Ativa_Fornecida = 163  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM2_710_Energia_Reativa_Consumida = 165  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM2_710_Energia_Ativa_Consumida = 167  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM2_710_Energia_Reativa_Fornecida = 169  # Op04 (Read Input Regs - 3x)
REG_SA_RetornosAnalogicos_Float_MWR_PM2_710_Energia_Ativa_Fornecida = 171  # Op04 (Read Input Regs - 3x)
...
REG_TDA_EntradasAnalogicas_MRR_NivelAntesGrade = 0  # Scale 0.01 - Op04 (Read Input Regs - 3x)
REG_TDA_EntradasAnalogicas_MRR_NivelDepoisGrade = 1  # Scale 0.01 - Op04 (Read Input Regs - 3x)
...
REG_TDA_EntradasAnalogicas_MRR_NivelAntesGradeFiltrado = 8  # Scale 0.01 - Op04 (Read Input Regs - 3x)
...
REG_TDA_ComandosDigitais_MXW_ResetGeral = 0  # Escrita de Word Simples (Preset Single Register - 4x)
REG_TDA_ComandosDigitais_MXW_Hab_Nivel = 1  # Escrita de Word Simples (Preset Single Register - 4x)
REG_TDA_ComandosDigitais_MXW_Desab_Nivel = 2  # Escrita de Word Simples (Preset Single Register - 4x)
REG_TDA_ComandosDigitais_MXW_Hab_Religamento52L = 3  # Escrita de Word Simples (Preset Single Register - 4x)
REG_TDA_ComandosDigitais_MXW_Desab_Religamento52L = 4  # Escrita de Word Simples (Preset Single Register - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_1_Religamento = 0  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_1_Alto = 1  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_1_Medio = 2  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_1_Baixo = 3  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_2_Religamento = 4  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_2_Alto = 5  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_2_Medio = 6  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_2_Baixo = 7  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_3_Religamento = 8  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_3_Alto = 9  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_3_Medio = 10  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Nivel_3_Baixo = 11  # Scale 0.01 - OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_1_Alta = 12  # OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_1_Media = 13  # OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_1_Baixa = 14  # OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_2_Alta = 15  # OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_2_Media = 16  # OpLeitura de Words (Read Holding Regs - 4x)
REG_TDA_SaidasAnalogicas_MRW_Potencia_2_Baixa = 17  # OpLeitura de Words (Read Holding Regs - 4x)
