...
class OcorrenciasUsn:
    ...
    def carregar_leituras(self) -> None:
        ...
        leitura_ED_se_rele_linha_falha = LeituraModbusBit(self.__clp["SA"], REG["CONDIC_SA"]["SA_ED_PSA_SE_RELE_LINHA_FALHA"], descr="[OCO-USN] Falha Relé de Linha")
        self.condicionadores_essenciais.append(CondicionadorBase(leitura_ED_se_rele_linha_falha, CONDIC_INDISPONIBILIZAR))

        # Bloqueios
        leitura_ED_bloq_stt_50bf = LeituraModbusBit(self.__clp["SA"], REG["CONDIC_SA"]["SA_ED_STT_BLOQUEIO_50BF"], descr="[OCO-USN] Status Bloqueio 50BF Relé SA")
        ...
        leitura_ED_bloq_stt_86btlsa = LeituraModbusBit(self.__clp["SA"], REG["CONDIC_SA"]["SA_ED_STT_BLOQUEIO_86BTLSA"], descr="[OCO-USN] Status Bloqueio 86BTLSA Relé SA")
...
class OcorrenciasUg:
    ...
    def carregar_leituras(self) -> None:
        ...
        self.leitura_dict[f"tmp_fase_r_ug{self.__ug_id}"] = LeituraModbus(
            ...
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_FASE_A"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_fase_s_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_FASE_B"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_fase_t_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_FASE_C"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_nucleo_gerador_1_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_NUCLEO_1"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_nucleo_gerador_2_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_NUCLEO_2"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_nucleo_gerador_3_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_GERADOR_NUCLEO_3"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_mancal_casq_rad_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_MANCAL_GUIA_CASQUILHO"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_mancal_casq_comb_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_MANCAL_COMBINADO_CASQUILHO"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_dict[f"tmp_mancal_escora_comb_ug{self.__ug_id}"] = LeituraModbus(
            self.__clp[f"UG{self.__ug_id}"],
            REG["CONDIC_UG"][f"UG{self.__ug_id}_EA_TEMPERATURA_MANCAL_COMBINADO_ESCORA"],
            escala=0.001,
            op=4
        )
        ...
        self.leitura_rv_falha_1 = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_RV_FALHA_1"], descr=f"[UG{self.__ug_id}] RV Falha 1")
        ...
        self.leitura_bloq_86e = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_STT_BLOQUEIO_86E"], descr=f"[UG{self.__ug_id}] Bloqueio 86E")
        self.condicionadores_essenciais.append(self.leitura_bloq_86e, CONDIC_NORMALIZAR)

        self.leitura_bloq_86h = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_STT_BLOQUEIO_86H"], descr=f"[UG{self.__ug_id}] Bloqueio 86H")
        ...
        # ENTRADAS DIGITAIS
        self.leitura_status_rv = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_STT_RV"], descr=f"[UG{self.__ug_id}] RV Status")
        self.condicionadores_essenciais.append(self.leitura_status_rv, CONDIC_INDISPONIBILIZAR)

        self.leitura_status_bloq_86m = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_STT_BLOQUEIO_86M"], descr=f"[UG{self.__ug_id}] Status Bloqueio 86M")
        ...
        self.leitura_uhlm_filtro_oleo_sujo = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_PRTVA_UHLM_FILTRO_OLEO_SUJO"], descr=f"[UG{self.__ug_id}] UHLM Filtro Óleo Sujo")
        ...
        self.leitura_psa_poco_dren_nv_muito_alto = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_PRTVA_PSA_POCO_DRENAGEM_NIVEL_MUITO_ALTO"], descr=f"[UG{self.__ug_id}] PSA Poço Drenagem Nível Muito Alto")
        ...
        # UHRV
        self.leitura_uhrv_falha_deslig = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_UHRV_FALHA_AO_DESLIGAR"], descr=f"[UG{self.__ug_id}] UHRV Falha Desligar")
        self.condicionadores_essenciais.append(self.leitura_uhrv_falha_deslig, CONDIC_INDISPONIBILIZAR)

        self.leitura_uhrv_indisp = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_UHRV_INDISPONIVEL"], descr=f"[UG{self.__ug_id}] UHRV Indisponível")
        self.condicionadores_essenciais.append(self.leitura_uhrv_indisp, CONDIC_INDISPONIBILIZAR)

        self.leitura_uhrv_falha_ligar = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_UHRV_FALHA_AO_LIGAR"], descr=f"[UG{self.__ug_id}] UHRV Falha Ligar")
        self.condicionadores_essenciais.append(self.leitura_uhrv_falha_ligar, CONDIC_INDISPONIBILIZAR)

        self.leitura_uhrv_falha_pressurizar = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_ED_UHRV_FALHA_AO_PRESSURIZAR"], descr=f"[UG{self.__ug_id}] UHRV Falha Pressurizar")
        ...
        self.leitura_rt_alar_1_lim_sup_pot_reativa = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_RT_ALARMES_1_LIMITE_SUP_POT_REATICA"], descr=f"[UG{self.__ug_id}] RT Alarmes 1 Limite Superior Potência Reativa")
        self.condicionadores_essenciais.append(self.leitura_rt_alar_1_lim_sup_pot_reativa, CONDIC_INDISPONIBILIZAR)

        self.leitura_rt_alar_1_lim_inf_pot_reativa = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_RT_ALARMES_1_LIMITE_INF_POT_REATIAVA"], descr=f"[UG{self.__ug_id}] RT Alarmes 1 Limite Inferior Potência Reativa")
        ...
        self.leitura_rt_falha_3_ruido_leit_instrum_principal = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_RT_FALHAS_3_RUIDO_INSTRUM_PRINCI"], descr=f"[UG{self.__ug_id}] RT Falha 3 Ruído Leitura Instrumentador Principal")
        self.condicionadores_essenciais.append(self.leitura_rt_falha_3_ruido_leit_instrum_principal, CONDIC_INDISPONIBILIZAR)

        self.leitura_rt_falha_3_ruido_leit_instrum_retag = LeituraModbusBit(self.__clp[f"UG{self.__ug_id}"], REG["CONDIC_UG"][f"UG{self.__ug_id}_RT_FALHAS_3_RUIDO_INSTRUM_RETAG"], descr=f"[UG{self.__ug_id}] RT Falha 3 Ruído Leitura Instrumentador Retaguarda")
        ...
        self.condicionadores_essenciais.append(self.leitura_uhrv_press_oleo_falha_leitura, CONDIC_INDISPONIBILIZAR)
