...
class Subestacao:
    ...
    def resetar_emergencia(self) -> bool:
        try:
            ...
            res = self.e_opc_bit.escrever(OPC_UA["SE"]["CMD_SE_REARME_BLOQUEIO_GERAL"], valor=1, bit=0)
            res = self.e_opc_bit.escrever(OPC_UA["SE"]["CMD_SE_REARME_86T"], valor=1, bit=1)
            res = self.e_opc_bit.escrever(OPC_UA["SE"]["CMD_SE_REARME_86BF"], valor=1, bit=2)
            res = self.e_opc_bit.escrever(OPC_UA["SE"]["REARME_86BF_86T"], valor=1, bit=22)
            res = self.e_opc_bit.escrever(OPC_UA["SE"]["CMD_SE_RESET_REGISTROS"], valor=1, bit=5)
            return res
