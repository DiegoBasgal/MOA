...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        # R
        self.leitura_temperatura_fase_R = LeituraModbus("Temperatura fase R".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_01,op=4,)
        base, limite = 100, 200
        ...
        # S
        self.leitura_temperatura_fase_S = LeituraModbus("Temperatura fase s".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_02,op=4,)
        base, limite = 100, 200
        ...
        # T
        self.leitura_temperatura_fase_T = LeituraModbus("Temperatura fase T".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_03,op=4,)
        base, limite = 100, 200
        ...
        # Nucleo estator
        self.leitura_temperatura_nucleo = LeituraModbus("Temperatura núcelo do estator".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_04,op=4,)
        base, limite = 100, 200
        ...
        # MRD 1
        self.leitura_temperatura_mrd1 = LeituraModbus("Temperatura mancal radial dianteiro".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_05,op=4,)
        base, limite = 100, 200
        ...
        # MRT 1
        self.leitura_temperatura_mrt1 = LeituraModbus("Temperatura mancal radial traseiro".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_06,op=4,)
        base, limite = 100, 200
        ...
        # MRD 2
        self.leitura_temperatura_mrd2 = LeituraModbus("Temperatura mancal radial dianteiro 2".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_07,op=4,)
        base, limite = 100, 200
        ...
        # MRT 2
        self.leitura_temperatura_mrt2 = LeituraModbus("Temperatura mancal radial traseiro 2".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_08,op=4,)
        base, limite = 100, 200
        ...
        # Saída de ar
        self.leitura_temperatura_saida_de_ar = LeituraModbus("Saída de ar".format(self.id),self.clp_ug2,REG_UG2_RetornosAnalogicos_MWR_Temperatura_10,op=4,)
        base, limite = 100, 200
        ...
        # Mancal Guia Radial
        self.leitura_temperatura_guia_radial = LeituraModbus("Mancal Guia Radial".format(self.id),self.clp_ug2,REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaRadial,)
        base, limite = 100, 200
        ...
        # Mancal Guia escora
        self.leitura_temperatura_guia_escora = LeituraModbus("Mancal Guia escora".format(self.id),self.clp_ug2,REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaEscora,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_guia_contra_escora = LeituraModbus("Mancal Guia contra_escora".format(self.id),self.clp_ug2,REG_UG2_EntradasAnalogicas_MRR_TempMcGuiaContraEscora,)
        base, limite = 100, 200
        ...
        # CX Espiral
        self.leitura_caixa_espiral = LeituraModbus("Caixa espiral".format(self.id),self.clp_ug2,REG_UG2_EntradasAnalogicas_MRR_PressK1CaixaExpiral_MaisCasas,escala=0.01,op = 4)
        base = 16.1
        limite = 15.5
        ...
        self.leitura_ComandosDigitais_MXW_EmergenciaViaSuper = LeituraModbusCoil("ComandosDigitais_MXW_EmergenciaViaSuper", self.clp_ug2, REG_UG2_ComandosDigitais_MXW_EmergenciaViaSuper,)
        ...
        self.leitura_RetornosDigitais_MXR_TripEletrico = LeituraModbusCoil("RetornosDigitais_MXR_TripEletrico",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripEletrico,)
        x = self.leitura_RetornosDigitais_MXR_TripEletrico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_NORMALIZAR, x))

        self.leitura_EntradasDigitais_MXI_ReleBloqA86HAtuado = LeituraModbusCoil("EntradasDigitais_MXI_ReleBloqA86HAtuado", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_ReleBloqA86HAtuado)
        ...
        self.leitura_EntradasDigitais_MXI_ReleBloqA86MAtuado = LeituraModbusCoil("EntradasDigitais_MXI_ReleBloqA86MAtuado", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_ReleBloqA86MAtuado)
        ...
        self.leitura_EntradasDigitais_MXI_SEL700G_Atuado = LeituraModbusCoil("EntradasDigitais_MXI_SEL700G_Atuado",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_SEL700G_Atuado,)
        x = self.leitura_EntradasDigitais_MXI_SEL700G_Atuado
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_RV_Trip = LeituraModbusCoil("EntradasDigitais_MXI_RV_Trip",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_RV_Trip,)
        x = self.leitura_EntradasDigitais_MXI_RV_Trip
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripMecanico = LeituraModbusCoil("RetornosDigitais_MXR_TripMecanico",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripMecanico,)
        x = self.leitura_RetornosDigitais_MXR_TripMecanico
        self.condicionadores_essenciais.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_700G_Trip = LeituraModbusCoil("RetornosDigitais_MXR_700G_Trip",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_700G_Trip,)
        ...
        self.leitura_EntradasDigitais_MXI_AVR_Trip = LeituraModbusCoil("EntradasDigitais_MXI_AVR_Trip",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_AVR_Trip,)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
        ...
        self.leitura_EntradasDigitais_MXI_AVR_FalhaInterna = LeituraModbusCoil("EntradasDigitais_MXI_AVR_FalhaInterna",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_AVR_FalhaInterna,)
        x = self.leitura_EntradasDigitais_MXI_AVR_FalhaInterna
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_Falta125Vcc = LeituraModbusCoil("EntradasDigitais_MXI_Falta125Vcc",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_Falta125Vcc,)
        x = self.leitura_EntradasDigitais_MXI_Falta125Vcc
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_Falta125VccAlimVal = LeituraModbusCoil("EntradasDigitais_MXI_Falta125VccAlimVal",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_Falta125VccAlimVal,)
        x = self.leitura_EntradasDigitais_MXI_Falta125VccAlimVal
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FalhaDisjTpsProt = LeituraModbusCoil("EntradasDigitais_MXI_FalhaDisjTpsProt",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FalhaDisjTpsProt,)
        x = self.leitura_EntradasDigitais_MXI_FalhaDisjTpsProt
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_SEL700G_FalhaInterna = LeituraModbusCoil("EntradasDigitais_MXI_SEL700G_FalhaInterna",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_SEL700G_FalhaInterna,)
        x = self.leitura_EntradasDigitais_MXI_SEL700G_FalhaInterna
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_NivelMAltoPocoDren = LeituraModbusCoil("EntradasDigitais_MXI_NivelMAltoPocoDren",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_NivelMAltoPocoDren,)
        x = self.leitura_EntradasDigitais_MXI_NivelMAltoPocoDren
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FreioFiltroSaturado = LeituraModbusCoil("EntradasDigitais_MXI_FreioFiltroSaturado",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FreioFiltroSaturado,)
        x = self.leitura_EntradasDigitais_MXI_FreioFiltroSaturado
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FreioSemEnergia = LeituraModbusCoil("EntradasDigitais_MXI_FreioSemEnergia",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FreioSemEnergia,)
        x = self.leitura_EntradasDigitais_MXI_FreioSemEnergia
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FiltroPresSujo100Sujo = LeituraModbusCoil("EntradasDigitais_MXI_FiltroPresSujo100Sujo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FiltroPresSujo100Sujo,)
        x = self.leitura_EntradasDigitais_MXI_FiltroPresSujo100Sujo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FiltroRetSujo100Sujo = LeituraModbusCoil("EntradasDigitais_MXI_FiltroRetSujo100Sujo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FiltroRetSujo100Sujo,)
        x = self.leitura_EntradasDigitais_MXI_FiltroRetSujo100Sujo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHRV_NivOleoCriticoPos35 = LeituraModbusCoil("EntradasDigitais_MXI_UHRV_NivOleoCriticoPos35",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHRV_NivOleoCriticoPos35,)
        x = self.leitura_EntradasDigitais_MXI_UHRV_NivOleoCriticoPos35
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHRV_NivOleominimoPos36 = LeituraModbusCoil("EntradasDigitais_MXI_UHRV_NivOleominimoPos36",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHRV_NivOleominimoPos36,)
        x = self.leitura_EntradasDigitais_MXI_UHRV_NivOleominimoPos36
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_ValvBorbTravada = LeituraModbusCoil("EntradasDigitais_MXI_ValvBorbTravada",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_ValvBorbTravada,)
        x = self.leitura_EntradasDigitais_MXI_ValvBorbTravada
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_SobreVeloMecPos18 = LeituraModbusCoil("EntradasDigitais_MXI_SobreVeloMecPos18",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_SobreVeloMecPos18,)
        x = self.leitura_EntradasDigitais_MXI_SobreVeloMecPos18
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FaltaFluxoOleoMc = LeituraModbusCoil("EntradasDigitais_MXI_FaltaFluxoOleoMc",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FaltaFluxoOleoMc,)
        x = self.leitura_EntradasDigitais_MXI_FaltaFluxoOleoMc
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_PalhetasDesal = LeituraModbusCoil("EntradasDigitais_MXI_PalhetasDesal",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_PalhetasDesal,)
        x = self.leitura_EntradasDigitais_MXI_PalhetasDesal
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_FaltaFluxTroc = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_FaltaFluxTroc",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_FaltaFluxTroc,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_FaltaFluxTroc
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_FaltaPressTroc = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_FaltaPressTroc",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_FaltaPressTroc,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_FaltaPressTroc
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_Filt1PresSujo100Sujo = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_Filt1PresSujo100Sujo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_Filt1PresSujo100Sujo,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_Filt1PresSujo100Sujo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_Filt2PresSujo100Sujo = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_Filt2PresSujo100Sujo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_Filt2PresSujo100Sujo,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_Filt2PresSujo100Sujo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_NivelCritOleo = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_NivelCritOleo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_NivelCritOleo,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_NivelCritOleo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_NivelminOleo = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_NivelminOleo",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_NivelminOleo,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_NivelminOleo
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_FiltroPressaoBbaMecSj100 = LeituraModbusCoil("EntradasDigitais_MXI_FiltroPressaoBbaMecSj100",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_FiltroPressaoBbaMecSj100,)
        x = self.leitura_EntradasDigitais_MXI_FiltroPressaoBbaMecSj100
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_FluxoMcDianteiro = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_FluxoMcDianteiro",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_FluxoMcDianteiro,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_FluxoMcDianteiro
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_FluxoMcTras = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_FluxoMcTras",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_FluxoMcTras,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_FluxoMcTras
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_QCAUG_Falha380VcaPainel = LeituraModbusCoil("EntradasDigitais_MXI_QCAUG_Falha380VcaPainel",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_QCAUG_Falha380VcaPainel,)
        ...
        self.leitura_EntradasDigitais_MXI_QCAUG_TripDisj52A1 = LeituraModbusCoil("EntradasDigitais_MXI_QCAUG_TripDisj52A1",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_QCAUG_TripDisj52A1,)
        x = self.leitura_EntradasDigitais_MXI_QCAUG_TripDisj52A1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_TripBomba1 = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_TripBomba1",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_TripBomba1,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_TripBomba1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHLM_TripBomba2 = LeituraModbusCoil("EntradasDigitais_MXI_UHLM_TripBomba2",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHLM_TripBomba2,)
        x = self.leitura_EntradasDigitais_MXI_UHLM_TripBomba2
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHRV_TripBomba1 = LeituraModbusCoil("EntradasDigitais_MXI_UHRV_TripBomba1",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHRV_TripBomba1,)
        x = self.leitura_EntradasDigitais_MXI_UHRV_TripBomba1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_UHRV_TripBomba2 = LeituraModbusCoil("EntradasDigitais_MXI_UHRV_TripBomba2",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_UHRV_TripBomba2,)
        x = self.leitura_EntradasDigitais_MXI_UHRV_TripBomba2
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_TripAlimPainelFreio = LeituraModbusCoil("EntradasDigitais_MXI_TripAlimPainelFreio",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_TripAlimPainelFreio,)
        x = self.leitura_EntradasDigitais_MXI_TripAlimPainelFreio
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_EntradasDigitais_MXI_QCAUG_TripDisjAgrup = LeituraModbusCoil("EntradasDigitais_MXI_QCAUG_TripDisjAgrup",self.clp_ug2,REG_UG2_EntradasDigitais_MXI_QCAUG_TripDisjAgrup,)
        x = self.leitura_EntradasDigitais_MXI_QCAUG_TripDisjAgrup
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_FalhaAcionFechaValvBorb = LeituraModbusCoil("RetornosDigitais_MXR_FalhaAcionFechaValvBorb",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_FalhaAcionFechaValvBorb,)
        x = self.leitura_RetornosDigitais_MXR_FalhaAcionFechaValvBorb
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM1 = LeituraModbusCoil("RetornosDigitais_MXR_UHRV_FalhaAcionBbaM1",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM1,)
        x = self.leitura_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM2 = LeituraModbusCoil("RetornosDigitais_MXR_UHRV_FalhaAcionBbaM2",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM2,)
        x = self.leitura_RetornosDigitais_MXR_UHRV_FalhaAcionBbaM2
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM1 = LeituraModbusCoil("RetornosDigitais_MXR_UHLM_FalhaAcionBbaM1",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM1,)
        x = self.leitura_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM2 = LeituraModbusCoil("RetornosDigitais_MXR_UHLM_FalhaAcionBbaM2",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM2,)
        x = self.leitura_RetornosDigitais_MXR_UHLM_FalhaAcionBbaM2
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempGaxeteiro = LeituraModbusCoil("RetornosDigitais_MXR_TripTempGaxeteiro",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempGaxeteiro,)
        x = self.leitura_RetornosDigitais_MXR_TripTempGaxeteiro
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempMcGuiaRadial = LeituraModbusCoil("RetornosDigitais_MXR_TripTempMcGuiaRadial",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempMcGuiaRadial,)
        x = self.leitura_RetornosDigitais_MXR_TripTempMcGuiaRadial
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempMcGuiaEscora = LeituraModbusCoil("RetornosDigitais_MXR_TripTempMcGuiaEscora",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempMcGuiaEscora,)
        x = self.leitura_RetornosDigitais_MXR_TripTempMcGuiaEscora
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempMcGuiaContraEscora = (LeituraModbusCoil("RetornosDigitais_MXR_TripTempMcGuiaContraEscora",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempMcGuiaContraEscora,))
        x = self.leitura_RetornosDigitais_MXR_TripTempMcGuiaContraEscora
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempUHRV = LeituraModbusCoil("RetornosDigitais_MXR_TripTempUHRV",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempUHRV,)
        x = self.leitura_RetornosDigitais_MXR_TripTempUHRV
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripTempUHLM = LeituraModbusCoil("RetornosDigitais_MXR_TripTempUHLM",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripTempUHLM,)
        x = self.leitura_RetornosDigitais_MXR_TripTempUHLM
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripVibr1 = LeituraModbusCoil("RetornosDigitais_MXR_TripVibr1",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripVibr1,)
        x = self.leitura_RetornosDigitais_MXR_TripVibr1
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_TripVibr2 = LeituraModbusCoil("RetornosDigitais_MXR_TripVibr2",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_TripVibr2,)
        x = self.leitura_RetornosDigitais_MXR_TripVibr2
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_FalhaIbntDisjGer = LeituraModbusCoil("RetornosDigitais_MXR_FalhaIbntDisjGer",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_FalhaIbntDisjGer,)
        x = self.leitura_RetornosDigitais_MXR_FalhaIbntDisjGer
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_CLP_Falha = LeituraModbusCoil("RetornosDigitais_MXR_CLP_Falha",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_CLP_Falha,)
        x = self.leitura_RetornosDigitais_MXR_CLP_Falha
        self.condicionadores.append(CondicionadorBase(x.descr, DEVE_INDISPONIBILIZAR, x))

        self.leitura_RetornosDigitais_MXR_Q_Negativa = LeituraModbusCoil("RetornosDigitais_MXR_Q_Negativa",self.clp_ug2,REG_UG2_RetornosDigitais_MXR_Q_Negativa,)
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def acionar_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp_ug2.write_single_coil(
    ...
    def remover_trip_logico(self) -> bool:
        ...
        try:
            ...
            response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetGeral, 1)
            response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetReleBloq86H, 1)
            response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetReleBloq86M, 1)
            response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetRele700G, 1)
            ...
            response = self.clp_ug2.write_single_coil(REG_UG2_EntradasDigitais_MXI_ReleBloqA86HAtuado, 0)
            response = self.clp_ug2.write_single_coil(REG_UG2_EntradasDigitais_MXI_ReleBloqA86MAtuado, 0)
            response = self.clp_ug2.write_single_coil(REG_UG2_RetornosDigitais_MXR_700G_Trip, 0)
        except:
            #! TODO Tratar exceptions
            return False
        else:
    ...
    def remover_trip_eletrico(self) -> bool:
        ...
        try:
            ...
            response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_Cala_Sirene, 1)
    ...
    def partir(self) -> bool:
        ...
        try:
            ...
            if not self.clp_ug2.read_discrete_inputs(REG_UG2_COND_PART,1)[0]:
                ...
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetReleBloq86H, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetReleBloq86M, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetReleRT, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_ResetRV, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_IniciaPartida, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_Cala_Sirene, 1)
            else:
    ...
    def parar(self) -> bool:
        ...
        try:
            if not self.etapa_atual == UNIDADE_PARADA:
                ...
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_AbortaPartida, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_AbortaSincronismo, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_IniciaParada, 1)
                response = self.clp_ug2.write_single_coil(REG_UG2_ComandosDigitais_MXW_Cala_Sirene, 1)
    ...
    def enviar_setpoint(self, setpoint_kw: int) -> bool:
        ...
        try:
            ...
            if self.setpoint > 1:
                ...
                response = self.clp_ug2.write_single_register(
    ...
    def leituras_por_hora(self):
        self.leitura_EntradasDigitais_MXI_FreioPastilhaGasta = LeituraModbusCoil( "EntradasDigitais_MXI_FreioPastilhaGasta", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_FreioPastilhaGasta )
        ...
        self.leitura_EntradasDigitais_MXI_FiltroPresSujo75Troc = LeituraModbusCoil( "EntradasDigitais_MXI_FiltroPresSujo75Troc", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_FiltroPresSujo75Troc )
        ...
        self.leitura_EntradasDigitais_MXI_FiltroRetSujo75Troc = LeituraModbusCoil( "EntradasDigitais_MXI_FiltroRetSujo75Troc", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_FiltroRetSujo75Troc )
        ...
        self.leitura_EntradasDigitais_MXI_UHLMFilt1PresSujo75Troc = LeituraModbusCoil( "EntradasDigitais_MXI_UHLMFilt1PresSujo75Troc", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_UHLM_Filt1PresSujo75Troc )
        ...
        self.leitura_EntradasDigitais_MXI_UHLMFilt2PresSujo75Troc = LeituraModbusCoil( "EntradasDigitais_MXI_UHLMFilt2PresSujo75Troc", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_UHLM_Filt2PresSujo75Troc )
        ...
        self.leitura_EntradasDigitais_MXI_FiltroPressaoBbaMecSj75 = LeituraModbusCoil( "EntradasDigitais_MXI_FiltroPressaoBbaMecSj75", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_FiltroPressaoBbaMecSj75 )
        ...
        self.leitura_EntradasDigitais_MXI_TripPartRes = LeituraModbusCoil( "EntradasDigitais_MXI_TripPartRes", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_TripPartRes )
        ...
        self.leitura_EntradasDigitais_MXI_FreioCmdRemoto = LeituraModbusCoil( "EntradasDigitais_MXI_FreioCmdRemoto", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_FreioCmdRemoto )
        if self.leitura_EntradasDigitais_MXI_FreioCmdRemoto.valor == 0 and self.FreioCmdRemoto == True:
            self.logger.debug("[UG{}] O sensor de freio da UG saiu do modo remoto, favor analisar a situação.".format(self.id))
            self.FreioCmdRemoto = False
        elif self.leitura_EntradasDigitais_MXI_FreioCmdRemoto.valor == 1 and self.FreioCmdRemoto == False:
            self.FreioCmdRemoto = True

        self.leitura_EntradasDigitais_MXI_QCAUG2_Remoto = LeituraModbusCoil( "EntradasDigitais_MXI_QCAUG2_Remoto", self.clp_ug2, REG_UG2_EntradasDigitais_MXI_QCAUG2_Remoto )
