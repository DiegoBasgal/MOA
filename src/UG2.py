...
class UnidadeDeGeracao2(UnidadeDeGeracao):
    def __init__(self, id, cfg=None, leituras_usina=None):
        ...
        self.leitura_potencia = LeituraModbus("ug{}_Gerador_PotenciaAtivaMedia".format(self.id),self.clp,REG_UG2_Gerador_PotenciaAtivaMedia,)

        self.leitura_horimetro = LeituraModbus("ug{}_HorimetroEletrico_Low".format(self.id),self.clp,REG_UG2_HorimetroEletrico_Low,)

        self.leitura_Operacao_EtapaAtual = LeituraModbus("ug{}_Operacao_EtapaAtual".format(self.id),self.clp,REG_UG2_Operacao_EtapaAtual,)

        self.leitura_Operacao_EtapaAlvo = LeituraModbus("ug{}_Operacao_EtapaAlvo".format(self.id),self.clp,REG_UG2_Operacao_EtapaAlvo,)

        # Gerador - Enrolamento fase R
        self.leitura_temperatura_enrolamento_fase_r = LeituraModbus("Gerador {} - Enrolamento fase R".format(self.id),self.clp,REG_UG2_Temperatura_01,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_enrolamento_fase_s = LeituraModbus("Gerador {} - Enrolamento Fase S".format(self.id),self.clp,REG_UG2_Temperatura_02,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_enrolamento_fase_t = LeituraModbus("Gerador {} - Enrolamento fase T".format(self.id),self.clp,REG_UG2_Temperatura_03,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_la_escora_1 = LeituraModbus("Gerador {} - Mancal L.A. Escora 01".format(self.id),self.clp,REG_UG2_Temperatura_04,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_la_escora_2 = LeituraModbus("Gerador {} - Mancal L.A. Escora 02".format(self.id),self.clp,REG_UG2_Temperatura_05,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_la_contra_escora_1 = LeituraModbus("Gerador {} - Mancal L. A. Contra Escora 01".format(self.id),self.clp,REG_UG2_Temperatura_07,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_la_contra_escora_2 = LeituraModbus("Gerador {} - Mancal L. A. Contra Escora 02".format(self.id),self.clp,REG_UG2_Temperatura_09,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_la_casquilho = LeituraModbus("Gerador {} - Mancal L. A. Casquilho".format(self.id),self.clp,REG_UG2_Temperatura_06,)
        base, limite = 100, 200
        ...
        self.leitura_temperatura_mancal_lna_casquilho = LeituraModbus("Gerador {} - Mancal L.N.A. Casquilho".format(self.id),self.clp,REG_UG2_Temperatura_08,)
        base, limite = 100, 200
    ...
    def leituras_por_hora(self) -> bool:
        ...
        self.alarme_sobretemperatura_mancal_la_escora_1 = LeituraModbusBit("08.01 - Alarme de Sobretemperatura do Mancal LA do Gerador (Escora 1) via CLP", self.clp, REG_UG2_Alarme08, 01)
        ...
        self.alarme_sobretemperatura_mancal_la_escora_2 = LeituraModbusBit("08.02 - Alarme de Sobretemperatura do Mancal LA do Gerador (Escora 2) via CLP", self.clp, REG_UG2_Alarme08, 02)
        ...
        self.alarme_sobretemperatura_mancal_la_casquilho = LeituraModbusBit("08.03 - Alarme de Sobretemperatura do Mancal LA do Gerador (Casquilho) via CLP", self.clp, REG_UG2_Alarme08, 03)
        ...
        self.alarme_sobretemperatura_mancal_lna_casquilho = LeituraModbusBit("08.05 - Alarme de Sobretemperatura do Mancal LNA do Gerador (Casquilho) via CLP", self.clp, REG_UG2_Alarme08, 05)
        if self.alarme_sobretemperatura_mancal_lna_casquilho.valor != 0:
            self.logger.warning("[UG2] O alarme de sobretemperatura do mancal LA casquilho do gerador foi ativado! Favor verificar.")
        
        self.alarme_sobretemperatura_mancal_la_contra_escora_1 = LeituraModbusBit("08.04 - Alarme de Sobretemperatura do Mancal LA do Gerador (Contra-Escora 1) via CLP", self.clp, REG_UG2_Alarme08, 04)
        ...
        self.alarme_sobretemperatura_mancal_la_contra_escora_2 = LeituraModbusBit("08.06 - Alarme de Sobretemperatura do Mancal LA do Gerador (Contra-Escora 2) via CLP", self.clp, REG_UG2_Alarme08, 06)
        ...
        self.alarme_sobretemperatura_vedacao_eixo_turb = LeituraModbusBit("08.07 - Alarme de Sobretemperatura da Vedação do Eixo da Turbina via CLP", self.clp, REG_UG2_Alarme08, 07)
        ...
        self.alarme_sobretemperatura_oleo_reser_uhlm = LeituraModbusBit("08.08 - Alarme de Sobretemperatura do Óleo do Reservatório da UHLM via CLP", self.clp, REG_UG2_Alarme08, 08)
        ...
        self.alarme_sobretemperatura_oleo_saida_troc_calor = LeituraModbusBit("08.09 - Alarme de Sobretemperatura do Óleo na Saída do Trocador de Calor da UHLM via CLP", self.clp, REG_UG2_Alarme08, 09)
        ...
        self.alarme_vibracao_excessiva_mancal_lna = LeituraModbusBit("15.02 - Alarme - Vibração Excessiva no Mancal LNA do Gerador", self.clp, REG_UG2_Alarme15, 02)
