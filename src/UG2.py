...
class UnidadeDeGeracao2(UnidadeDeGeracao):
    ...
    def reconhece_reset_alarmes(self) -> bool:
        ...
        try:
            ...
            response = response and self.clp.write_single_register(
                REG_UG2_Operacao_PainelResetAlarmes, 1
            )
        except:
            #! TODO Tratar exceptions
            return False
    ...
    def etapa_alvo(self) -> int:
        try:
            response = self.clp.read_holding_registers(REG_UG2_Operacao_EtapaAlvo)[0]
        except:
            #! TODO Tratar exceptions
            return False
        else:
    ...
    def etapa_atual(self) -> int:
        try:
            response = self.clp.read_holding_registers(REG_UG2_Operacao_EtapaAtual)[0]
        except:
            #! TODO Tratar exceptions
            return False
        else:
